...
setup(
    ...
    url="https://github.com/yourusername/leadpoet-subnet",  # Replace with your GitHub URL
    ...
    entry_points={
        "console_scripts": [
            ...
            "leadpoet-api=template.api.leadpoet_api:main"  # CLI entry for API (if implemented)
        ]
    },
    classifiers=[
