...
def gateway_get_epoch_leads(wallet: bt.Wallet, epoch_id: int) -> tuple:
    ...
    try:
        ...
        if not leads:
            ...
            # retried. The validator must mark the empty epoch as processed
            # so later work is not blocked.
            #
            # Returning (None, max) makes the validator treat this as
            # "already processed / nothing to do" and marks the epoch as
            # processed. HTTP errors
