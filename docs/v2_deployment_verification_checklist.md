...
- Scoring setup/cycle failures and claim denials do not stop weights. New
  execute/score claims require registration, a validator permit, and effective
  stake >=75,000, regardless of activity or runner lists. Existing leases do not
  gain a stake minimum at completion. Capacity counts eligible planned runners.
