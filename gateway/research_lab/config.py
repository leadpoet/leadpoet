...
DEFAULT_PROVIDER_COST_CAP_USD_PER_ICP = 5.00
...
STALE_PARENT_REBASE_REPAIR_MODEL_ID = os.getenv(
    "RESEARCH_LAB_STALE_PARENT_REBASE_REPAIR_MODEL", "anthropic/claude-opus-4.8"
).strip() or "anthropic/claude-opus-4.8"
