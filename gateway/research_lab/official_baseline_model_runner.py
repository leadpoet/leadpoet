...
OFFICIAL_BASELINE_PROJECTION_SCHEMA_VERSION = "leadpoet.model.benchmark_projection.v1"
...
def _validate_projection(
    ...
    *,
    ...
    outputs = _validate_company_outputs(projection.outputs)
    ...
    body = {
        ...
        "source_result_sha256": terminal_result_sha256,
        "outputs_sha256": sha256_json(list(outputs)),
    }
    if dict(receipt) != {**body, "projection_sha256": sha256_json(body)}:
        raise OfficialBaselineModelError(
...
def _validate_provider_frontier_closure(
    value: Any,
    *,
...
class ExactOfficialBaselineRunner:
    ...
    def _finish_unit(
        ...
        *,
        ...
        closure = _validate_provider_frontier_closure(
        ...
        if (
            _validate_provider_frontier_closure(
