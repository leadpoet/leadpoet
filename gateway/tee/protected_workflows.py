...
PROTECTED_SYMBOLS = {
    ...
    "research_lab/sourcing_model_contract_check.py": (
        ...
        "_PIPELINE_STRUCTURE_SCHEMA_VERSION",
        "_PIPELINE_STAGE_VALUES",
        "_PIPELINE_IMPORTED_TOOL_IDS",
        "_PIPELINE_KNOWN_IMPORTED_VALUES",
        ...
        "_PIPELINE_POLICY_MUTABLE_FIELDS",
        "_PIPELINE_TOOL_MUTABLE_FIELDS",
        "_PIPELINE_SIGNAL_TOOL_MUTABLE_FIELDS",
        "_PIPELINE_SOURCE_ADD_MUTABLE_FIELDS",
        ...
        "_same_literal",
        "_call_name",
        "_has_single_unaliased_relative_import",
        "_function_rebinds",
        "_node_hash",
        "_top_level_binding_nodes",
        "_simple_string_constants",
        "_call_argument",
        "_resolve_string",
        "_resolve_stages",
        "_without_docstring",
        "_collection_items",
        "_is_pipeline_data_expression",
        "_PIPELINE_UNRESOLVED",
        "_PIPELINE_IDENTIFIER_RE",
        "_PIPELINE_FEATURE_RE",
        "_PIPELINE_TOOL_CONTRACT_ID_RE",
        "_PIPELINE_TOOL_CONTRACT_TOKEN_RE",
        "_PIPELINE_VERSION_RE",
        "_PIPELINE_PROVIDER_ID_RE",
        "_PIPELINE_SHA256_RE",
        "_pipeline_literal_value",
        "_pipeline_static_values",
        "_pipeline_static_values_before",
        "_pipeline_static_values_for_module",
        "_pipeline_static_values_for_module_before",
        "_pipeline_unresolved_name",
        "_pipeline_string_sequence",
        "_pipeline_constructor_semantic_errors",
        "_pipeline_prompt_binding_errors",
        "_source_add_registration_values",
        "_normalize_source_add_registration_static",
        "_pipeline_routing_policy_errors",
        "_declarative_constructor_call",
        "_normalized_expansion",
        "_normalized_collection_entry",
        "_membership_record",
        "_module_protected_binding_violations",
        "_assigned_name_and_value",
        "_assignment_with_sentinel",
        "_collection_function_shell",
        "_normalized_prompt_output_expression",
        "_simple_assignment_target",
        "_prompt_call_sink",
        "_PromptStringNormalizer",
        "_module_edit_surface_projection",
        "_local_route_context_bindings",
        "_compile_route_context",
        "_router_stage_binding_violations",
        "_assigned_value",
        "_pipeline_membership_projection",
    ...
    "gateway/research_lab/provider_capabilities.py": (
        ...
        "_SOURCE_ADD_MUTABLE_RUNTIME_FUNCTIONS",
        "_SOURCE_ADD_PROTECTED_ROUTER_NAMES",
    ...
    "gateway/research_lab/promotion.py": (
        ...
        "_pipeline_structure_commitment_errors",
