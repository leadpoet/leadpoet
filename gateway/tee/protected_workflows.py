...
PROTECTED_SYMBOLS = {
    ...
    "research_lab/sourcing_model_contract_check.py": (
        ...
        "CONTRACT_V68_A6F_PATH",
        "PARITY_FIXTURE_V28_A6F_PATH",
        ...
        "MAX_ADDITIONAL_TYPED_DISPATCH_PROFILES",
        ...
        "_sha256_json",
        "_ast_sha256",
        "_typed_dispatch_reviewed_profiles_v1",
        "_typed_dispatch_profile_for_pair_v1",
    ...
    "research_lab/eval/private_runtime.py": (
        "EXPECTED_SOURCING_ADAPTER_VERSIONS",
        ...
        "QUALIFICATION_OUTCOME_SUPPORTED_CONTRACT_SHA256S_V2",
        ...
        "_QUALIFICATION_OUTCOME_BRANCH_CONTROL_DEADLINE_POLICY_V1",
        ...
        "_QUALIFICATION_OUTCOME_HASH_RE",
        "qualification_outcome_contract_v2",
        "qualification_outcome_contract_sha256_v2",
        "_qualification_outcome_contract_sha256_supported_v2",
    ...
    "gateway/tee/update_gateway_rebenchmark_retry_secret.py": (
        ...
        "_parse_environment",
        "_render_environment",
        "_bounded_rebenchmark_concurrency",
