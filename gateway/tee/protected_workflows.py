...
PROTECTED_SYMBOLS = {
    ...
    "qualification/scoring/competition.py": (
        ...
        "DEFAULT_COMPANY_GOAL",
        "MAX_COMPANY_GOAL",
        "FP_PENALTY_POINTS",
        "_PENALIZABLE_FAILURE_MARKERS",
        "_NEVER_PENALIZE_MARKERS",
    ...
    "lab_arena/scoring.py": (
        ...
        "score_work_item",
        "build_stage_scores",
        "run_scores_for_store",
        "build_scoring_input",
        "build_scoring_output",
        "build_scoring_failure",
        "scoring_output_from_bytes",
        "validate_scoring_output_document",
        "validate_breakdowns_for_item",
    ),
    "lab_arena/verify.py": (
        "FINAL_DENOMINATOR",
        "STAGE_DENOMINATORS",
        "MAX_COMPANIES_PER_ICP",
        "ACCEPTED_CAUSE",
        "ZERO_ROW_CAUSES",
        "icp_company_goal",
        "icp_has_intent_signals",
        "slice_first_n",
        "company_employee_bucket",
        "bucket_skip",
        "per_icp_score",
        "zero_row",
        "scored_row",
        ...
        "king_decision",
        "result_is_valid",
        "redact_signal_detail",
        "redact_gate_receipt",
        "redact_breakdown",
        "breakdown_is_redacted",
    ),
