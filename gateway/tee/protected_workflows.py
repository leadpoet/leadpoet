...
PROTECTED_SYMBOLS = {
    ...
    "gateway/research_lab/routing_authority_bundle.py": (
        "ROUTING_AUTHORITY_BUNDLE_SCHEMA",
        "MAX_ROUTING_AUTHORITY_BUNDLE_BYTES",
        "_DOCUMENT_KEY_ROLES",
        "_canonical_bundle_size",
    ...
    "gateway/research_lab/routing_model_binding_observation.py": (
        ...
        "_validate_binding_manifest_row",
    ...
    "gateway/research_lab/routing_model_binding_producer.py": (
    ...
    "gateway/research_lab/routing_provider_bindings.py": (
        "ROUTING_BINDING_CATALOG_SCHEMA",
        "ROUTING_UNIT_DATASET_SCHEMA",
        "ROUTING_BINDING_SCHEMA",
        "DEEPLINE_COMPILER_FAMILY",
        "DEEPLINE_BASE_URL",
        "DEEPLINE_PROVIDER_PURPOSE",
        "DeeplineActionPolicy",
        "DEEPLINE_ACTION_POLICIES",
        "_MODEL_TOOL_ACTIONS",
        "_MODEL_TOOL_PROVIDER_IDS",
        "UNAVAILABLE_COMPOSITE_SOURCE_TOOLS",
        ...
        "_qualifying_direct_rows",
        "_billing",
    ),
    "gateway/research_lab/routing_provider_terminal_protected.py": (
    ...
    "gateway/research_lab/routing_experiment_reconciliation.py": (
        "build_input",
        "_labels",
        "_lineage",
        "_execution_envelope",
    ...
    "research_lab/sourcing_model_contract_check.py": (
        ...
        "_int_constant",
        "_module_symbols",
        "_module_bound_imports",
        "_module_scope_bindings",
        "_binding_nodes",
        "_required_import_matches_v1",
        "_required_import_binding_valid_v1",
        "_inert_definition_expression_v1",
        "_inert_additive_function_v1",
        "_inert_additive_literal_v1",
        "_function_local_names_v1",
        "_loaded_global_names_v1",
        "_critical_binding_slice_v1",
        "_literal_module_constants",
        "_unique_literal_binding_v1",
        "_same_literal",
        "_sha256_json",
        "_ast_sha256",
        ...
        "_semantic_compatibility_receipt",
        "validate_source_tree_compatibility_receipt_v1",
        "_semantic_contract_shape_violations_v1",
        "verify_semantic_source_tree_compatibility_v1",
    ...
    "research_lab/eval/private_runtime.py": (
        ...
        "PRIVATE_RUNTIME_FAILURE_CLASS_IDENTITY_MAX_BYTES",
    ...
    "gateway/research_lab/attested_v2_store.py": (
        ...
        "_MODEL_COMPATIBILITY_PURPOSE_V2",
    ...
    "gateway/research_lab/attested_scoring_v2.py": (
        ...
        "_load_model_compatibility_replay_v2",
    ...
    "gateway/research_lab/promotion.py": (
        ...
        "_activate_private_model_generation",
        "_fence_private_model_activation",
        "CandidateSourcePublicationPendingError",
        "CandidateSourceOwnershipUnavailableError",
        "_pending_candidate_source_publication_for_repo_head",
    ...
    "gateway/research_lab/model_authority_v2.py": (
        ...
        "_SHA256_RE",
        "_source_bundle_build_lock",
        "_validated_cached_source_bundle_and_receipt_v2",
        "_measured_compatibility_cache_key_v2",
        "_source_bundle_and_compatibility_receipt_for_artifact",
        "_source_bundle_for_artifact",
        "private_model_compatibility_receipt_v2",
        "_validate_measured_compatibility_admission_v2",
        "_combined_compatibility_proof_v2",
        "_execute_measured_compatibility_preflight_v2",
        "_empty_model_compatibility_provider_profile",
    ...
    "gateway/tee/gateway_miner_maintenance_restart_v1.py": (
        ...
        "_resolve_bootstrap_aws_clients",
        ...
        "_verify_locked_release_matches",
    ...
    "gateway/tee/model_sandbox_v2.py": (
        ...
        "_run_bounded_metadata_process",
        "_bounded_metadata_process_runner",
        "_force_delete_runsc_sandbox",
        "_request",
        "_oci_config",
        "RunscModelSandboxV2._run_metadata_compatibility",
        "RunscModelSandboxV2",
    ),
    ...
    "gateway/tee/sandbox_provider_socket_v2.py": (
        "_shutdown_and_close_socket",
        "SandboxProviderSocketServerV2",
    ),
    "gateway/tee/sandbox_http_shim_v2.py": (
        "EVIDENCE_MISS_SENTINEL",
        "_EVIDENCE_MISS_WRITE",
        "_cached_terminal",
    ...
    "gateway/tee/tee_service.py": (
        ...
        "configure_v2_scoring_routing_authority_bundle",
