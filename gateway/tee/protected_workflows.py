...
PROTECTED_SYMBOLS = {'gateway/main.py': ('lifespan',),
 ...
 'gateway/research_lab/attested_v2_store.py': ('_ANCESTRY_CHECKPOINT_UNKNOWN_COMMIT_BACKOFF_SECONDS',
 ...
 'gateway/research_lab/attested_artifacts_v2.py': ('_select_committed_encrypted_artifacts',
                                                   'persist_execution_transport_artifacts_v2'),
 'gateway/research_lab/attested_scoring_v2.py': ('_local_failed_receipt_hashes',
 ...
 'gateway/research_lab/v2_authority.py': ('execute_provider_preflight_v2',),
