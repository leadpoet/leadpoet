...
PROTECTED_SYMBOLS = {
    ...
    "research_lab/sourcing_model_contract_check.py": (
        ...
        "qualification_protocol_source_tree_admission_v2",
        "validate_qualification_protocol_source_receipt_v2",
    ...
    "research_lab/eval/private_runtime.py": (
        ...
        "QUALIFICATION_OUTCOME_REQUIRED_ROUTE_OUTCOME_STATES_V2",
        "QUALIFICATION_OUTCOME_REQUIRED_ROUTE_COMMITMENT_PATTERN_V2",
        "QUALIFICATION_OUTCOME_REQUIRED_CAPABILITIES_V2",
        ...
        "_qualification_outcome_extensions_valid_v2",
    ...
    "gateway/research_lab/scoring_worker.py": (
        ...
        "ResearchLabGatewayScoringWorker._run_baseline_icp",
    ),
    ...
    "gateway/tee/provider_client_v2.py": (
        ...
        "_QUALIFICATION_ROUTE_COMMITMENT_RE",
        "_MAX_QUALIFICATION_ROUTE_COMMITMENTS",
        "_headers_without_credentials",
        "_qualification_route_commitment",
        "_ExecutionScope",
    ...
    "gateway/tee/sandbox_provider_socket_v2.py": (
        "SANDBOX_PROVIDER_LOCAL_REPLAY_KIND_FIELD",
        "SANDBOX_PROVIDER_LOCAL_REPLAY_KINDS",
        "_normalize_request",
        "_shutdown_and_close_socket",
    ...
    "gateway/tee/sandbox_http_shim_v2.py": (
        ...
        "QUALIFICATION_PROTOCOL_V2_ENV",
        "LOCAL_REPLAY_KIND_FIELD",
        "LOCAL_REPLAY_KINDS",
        "_QUALIFICATION_ROUTE_COMMITMENT_HEADER",
        "_QUALIFICATION_ROUTE_COMMITMENT_RE",
        "_headers",
