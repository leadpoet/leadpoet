...
PROTECTED_SYMBOLS = {
    ...
    "gateway/research_lab/official_baseline_store.py": (
        ...
        "_validate_run_registration",
        "_validate_action_authorization",
        "_validate_terminal_known",
        "_validate_terminal_uncertain",
        "_validate_replay_identity",
        "_validate_unit_completion",
    ...
    "gateway/research_lab/official_baseline_custody.py": (
        ...
        "S3OfficialBaselineDocumentCustody.custody_identity_sha256",
        "S3OfficialBaselineDocumentCustody.append_protected_action_claim",
        "S3OfficialBaselineDocumentCustody.load_protected_action_claim",
        "S3OfficialBaselineDocumentCustody.append_protected_action_progress",
        "S3OfficialBaselineDocumentCustody.load_protected_action_progress",
        "S3OfficialBaselineDocumentCustody.persist_protected_action_terminal",
        "S3OfficialBaselineDocumentCustody.load_protected_action_terminal",
        "S3OfficialBaselineDocumentCustody.persist_terminal_record",
        "S3OfficialBaselineDocumentCustody.load_terminal_record",
        "S3OfficialBaselineDocumentCustody.transition_repository",
        "S3OfficialBaselineTransitionRepository.resolve_run_protocol_generation",
        "S3OfficialBaselineTransitionRepository.load_model_transition",
        "S3OfficialBaselineTransitionRepository.append_model_transition",
        "S3OfficialBaselineTransitionRepository.expected_frontier_sha256",
    ),
    "gateway/research_lab/official_baseline_authority.py": (
        ...
        "_protected_result_from_document",
        "_protected_terminal_document",
        "_protected_terminal_from_document",
        "GatewayLocalProtectedActionBridge",
        "GatewayLocalProtectedActionBridge.prepare",
        "GatewayLocalProtectedActionBridge.execute_prepared",
        "GatewayLocalProtectedActionBridge.reconcile",
        "_ReservedOfficialBaselineDispatcher",
        "_ReservedOfficialBaselineDispatcher.dispatch_provider_action",
        "_ReservedOfficialBaselineDispatcher.replay_provider_action",
        "_ReservedOfficialBaselineDispatcher.verify_company_action",
        "_ReservedOfficialBaselineDispatcher.verify_intent_action",
        "_ReservedOfficialBaselineDispatcher.verify_contact_action",
        "AppendOnlyOfficialBaselineAuthority.preflight_run",
        "AppendOnlyOfficialBaselineAuthority.dispatcher_for_unit",
        "AppendOnlyOfficialBaselineAuthority.transition_repository_for_unit",
        "AppendOnlyOfficialBaselineAuthority.close_unit",
        "AppendOnlyOfficialBaselineAuthority.load_frontier",
    ...
    "gateway/research_lab/official_baseline_release_authorities.py": (
        ...
        "_reviewed_provider_transport_available",
        "_official_host_availability",
        "_proxy_base_url",
        "_GatewayEvidenceProxyClient",
        "_GatewayEvidenceProxyClient._proxied_url",
        "_GatewayEvidenceProxyClient.request",
        "ArtifactPreparedActionExecutor",
        "ArtifactPreparedActionExecutor.prepare",
        "ArtifactPreparedActionExecutor.execute_prepared",
        "ArtifactPreparedActionExecutor.reconcile",
        "load_official_baseline_release_components",
    ),
    "gateway/research_lab/scoring_worker.py": (
        ...
        "_exact_official_baseline_model_spec",
        "_OfficialBaselineEvidenceProxyLease",
        "_OfficialBaselineEvidenceProxyLease.validate_live",
        ...
        "ResearchLabGatewayScoringWorker._construct_official_baseline_exact_dependencies",
        "ResearchLabGatewayScoringWorker._start_official_baseline_proxy_for_release",
        "ResearchLabGatewayScoringWorker._close_active_official_baseline_evidence_proxy",
        "ResearchLabGatewayScoringWorker._maybe_run_private_baseline",
        "ResearchLabGatewayScoringWorker._maybe_run_private_baseline_impl",
