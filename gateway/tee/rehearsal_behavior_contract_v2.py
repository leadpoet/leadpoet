...
EXACT_PRODUCTION_ENTRYPOINTS = (
    ...
    "gateway/tee/source_bundle_v2.py",
    ...
    "gateway/research_lab/active_model_authority_v2.py",
    ...
    "gateway/research_lab/official_baseline_custody.py",
    "gateway/research_lab/official_baseline_authority.py",
    "gateway/research_lab/official_baseline_release_dependencies.py",
    "gateway/research_lab/code_build.py",
    "gateway/research_lab/attested_scoring.py",
    "gateway/research_lab/attested_v2_store.py",
    "gateway/research_lab/api.py",
    "gateway/research_lab/dev_eval_runner.py",
    "gateway/research_lab/icp_window.py",
    "gateway/research_lab/public_benchmarks.py",
    ...
    "gateway/research_lab/routing_experiment_api.py",
    "gateway/research_lab/routing_admission.py",
    "gateway/research_lab/routing_authority_bundle.py",
    "gateway/research_lab/routing_broker_authority.py",
    "gateway/research_lab/routing_consumer_supervisor.py",
    "gateway/research_lab/routing_execution_authorization.py",
    "gateway/research_lab/routing_execution_consumer.py",
    "gateway/research_lab/routing_execution_envelope.py",
    "gateway/research_lab/routing_experiment_artifacts.py",
    "gateway/research_lab/routing_experiment_attestation.py",
    "gateway/research_lab/routing_experiment_reconciliation.py",
    "gateway/research_lab/routing_experiment_runtime.py",
    "gateway/research_lab/routing_experiment_store.py",
    "gateway/research_lab/routing_experiment_worker.py",
    "gateway/research_lab/routing_model_binding_issuer.py",
    "gateway/research_lab/routing_model_binding_observation.py",
    "gateway/research_lab/routing_model_binding_producer.py",
    "gateway/research_lab/routing_predictleads_workflows.py",
    "gateway/research_lab/routing_product_bootstrap.py",
    "gateway/research_lab/routing_product_composition.py",
    "gateway/research_lab/routing_provider_bindings.py",
    "gateway/research_lab/routing_provider_terminal.py",
    "gateway/research_lab/routing_provider_terminal_protected.py",
    "gateway/research_lab/routing_registration.py",
