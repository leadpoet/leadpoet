-- Admit the measured hybrid candidate-evaluation purposes for scoring only.
...
public.research_lab_candidate_hybrid_purpose_contract_v1() IS
    'Fail-closed schema contract for scoring-only hybrid candidate evaluation receipts.';
