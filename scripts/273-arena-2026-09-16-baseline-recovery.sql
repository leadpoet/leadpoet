-- Exact fourth baseline rerun recovery for arena-2026-09-16.
-- Render only after the third native rerun is terminal and all active provider
...
BEGIN
  IF pg_catalog.to_regprocedure(
     ...
     OR pg_catalog.to_regclass(
       'public.lab_arena_sep16_baseline_recovery272_authority'
     ) IS NULL
     OR pg_catalog.to_regclass(
       'public.lab_arena_sep16_baseline_recovery272_audit'
     ) IS NULL
     OR pg_catalog.to_regprocedure(
    ...
    RAISE EXCEPTION 'apply current Arena migrations through 272 before 273';
  END IF;
END;
...
CREATE TABLE IF NOT EXISTS public.lab_arena_sep16_baseline_recovery273_authority (
  round_id TEXT PRIMARY KEY CHECK (round_id = 'arena-2026-09-16'),
  archive_round_id TEXT NOT NULL UNIQUE CHECK (
    archive_round_id = 'arena-2026-09-16-rerun272archive'
  ),
  archive_submission_id TEXT NOT NULL UNIQUE CHECK (
    archive_submission_id = 'baseline-2026-09-16-native-rerun272-archive'
  ),
  execute_namespace TEXT NOT NULL CHECK (execute_namespace = 'rerun273'),
  terminal_source_ref TEXT NOT NULL CHECK (
    terminal_source_ref = 'arena/arena-2026-09-16/sources/baseline-2026-09-16-recovery272.tar.gz'
  ),
  terminal_source_size_bytes BIGINT NOT NULL CHECK (
    terminal_source_size_bytes = 533090
  ),
  terminal_source_sha256 TEXT NOT NULL CHECK (
    terminal_source_sha256 = '72a008e2cacde52921c4be94951839edccc321d90de07741010a3100463eef32'
  ),
  terminal_source_commit TEXT NOT NULL CHECK (
    terminal_source_commit = '0a19bd28177628d01b5ce1f4fc54cc459d7d4f51'
  ),
  ...
  terminal_round_hash TEXT NOT NULL CHECK (
    terminal_round_hash = 'sha256:7082fb9be08b5cf49056c783b1fd43832cc94d0062e73be3d38a95f96b64ae25'
  ),
  terminal_baseline_submission_hash TEXT NOT NULL CHECK (
    terminal_baseline_submission_hash = 'sha256:bee625bbc82f69665b8e5336ff9428cc8d49fa99a0f7515a6ca9e61ebee8e6d2'
  ),
  terminal_baseline_runs_hash TEXT NOT NULL CHECK (
    terminal_baseline_runs_hash = 'sha256:9ab2450e7adb7643e3eaf91de02b2de05cef185edc3595eb6c745d7afdd8271b'
  ),
  terminal_baseline_ledger_hash TEXT NOT NULL CHECK (
    terminal_baseline_ledger_hash = 'sha256:da037688fc92a9da8de1c92adbcdb4efae5ac17a34f6754a4302a003a7ff46bf'
  ),
  terminal_baseline_run_count BIGINT NOT NULL CHECK (
    terminal_baseline_run_count = 30
  ),
  terminal_baseline_ledger_count BIGINT NOT NULL CHECK (
    terminal_baseline_ledger_count = 4577
  ),
  terminal_baseline_ledger_max_entry_id BIGINT NOT NULL CHECK (
    terminal_baseline_ledger_max_entry_id = 452962
  ),
  terminal_baseline_settled_microusd BIGINT NOT NULL CHECK (
    terminal_baseline_settled_microusd = 13233902
  ),
  terminal_baseline_uncertain_microusd BIGINT NOT NULL CHECK (
    terminal_baseline_uncertain_microusd = 66415603
  ),
  ...
  prior_recovery_authority_hash TEXT NOT NULL CHECK (
    prior_recovery_authority_hash = 'sha256:2a44564caddf7dbb7ddd08295f5fbb11422ca3efed56b059563471f4f9588a91'
  ),
  prior_recovery_audit_hash TEXT NOT NULL CHECK (
    prior_recovery_audit_hash = 'sha256:130b044a28f5f5bba4471eed68e6e60c447622e7bb2d1a18b37c55886085d23a'
  ),
  terminal_status_generation BIGINT NOT NULL CHECK (
    terminal_status_generation = 18
  ),
  terminal_stage_generation BIGINT NOT NULL CHECK (
    terminal_stage_generation = 14
  ),
...
ALTER TABLE public.lab_arena_sep16_baseline_recovery273_authority
  OWNER TO lab_arena_owner;
ALTER TABLE public.lab_arena_sep16_baseline_recovery273_authority
  ENABLE ROW LEVEL SECURITY;
REVOKE ALL ON public.lab_arena_sep16_baseline_recovery273_authority
  FROM PUBLIC, anon, authenticated, service_role, lab_arena_service;

CREATE TABLE IF NOT EXISTS public.lab_arena_sep16_baseline_recovery273_audit (
  round_id TEXT PRIMARY KEY CHECK (round_id = 'arena-2026-09-16'),
...
ALTER TABLE public.lab_arena_sep16_baseline_recovery273_audit
  OWNER TO lab_arena_owner;
ALTER TABLE public.lab_arena_sep16_baseline_recovery273_audit ENABLE ROW LEVEL SECURITY;
REVOKE ALL ON public.lab_arena_sep16_baseline_recovery273_audit
  FROM PUBLIC, anon, authenticated, service_role, lab_arena_service;

INSERT INTO public.lab_arena_sep16_baseline_recovery273_authority (
  ...
  'arena-2026-09-16', 'arena-2026-09-16-rerun272archive',
  'baseline-2026-09-16-native-rerun272-archive', 'rerun273',
  ...
  'sha256:bee625bbc82f69665b8e5336ff9428cc8d49fa99a0f7515a6ca9e61ebee8e6d2',
  'sha256:9ab2450e7adb7643e3eaf91de02b2de05cef185edc3595eb6c745d7afdd8271b',
  'sha256:da037688fc92a9da8de1c92adbcdb4efae5ac17a34f6754a4302a003a7ff46bf',
  30,
  4577,
  452962,
  13233902,
  ...
  'sha256:2a44564caddf7dbb7ddd08295f5fbb11422ca3efed56b059563471f4f9588a91',
  'sha256:130b044a28f5f5bba4471eed68e6e60c447622e7bb2d1a18b37c55886085d23a',
  18,
  14,
  'operator',
...
DECLARE
  v_authority public.lab_arena_sep16_baseline_recovery273_authority%ROWTYPE;
...
BEGIN
  ...
  FROM public.lab_arena_sep16_baseline_recovery273_authority
  WHERE round_id = 'arena-2026-09-16' FOR UPDATE;
  IF EXISTS (
    SELECT 1 FROM public.lab_arena_sep16_baseline_recovery273_audit
  ...
  FROM public.lab_arena_sep16_baseline_recovery272_authority AS row_value
  WHERE round_id = v_authority.round_id;
  SELECT 'sha256:' || pg_catalog.encode(extensions.digest(
    pg_catalog.to_jsonb(row_value)::TEXT, 'sha256'), 'hex')
  INTO v_prior_recovery_audit_hash
  FROM public.lab_arena_sep16_baseline_recovery272_audit AS row_value
  WHERE round_id = v_authority.round_id;
  ...
  IF v_round_hash IS DISTINCT FROM v_authority.terminal_round_hash
     ...
     OR (SELECT pg_catalog.count(DISTINCT assignment_id)
         ...
         WHERE round_id = v_authority.round_id
           AND submission_id = 'baseline-2026-09-16'
           AND kind = 'execute' AND assignment_id LIKE '%:rerun272') <> 20
     OR EXISTS (
       SELECT 1 FROM public.lab_arena_runs
       WHERE round_id = v_authority.round_id
         AND submission_id = 'baseline-2026-09-16'
         AND (kind <> 'execute' OR attempt NOT IN (1, 2)
              OR assignment_id NOT LIKE '%:rerun272')
     ) THEN
    RAISE EXCEPTION 'Sep16 terminal native rerun seal differs before recovery273'
      USING ERRCODE = '55000';
  END IF;
END;
$seal_terminal_sep16_rerun$;

CREATE OR REPLACE FUNCTION public.lab_arena_sep16_recovery273_archive_valid_v1()
RETURNS BOOLEAN
LANGUAGE plpgsql STABLE SECURITY DEFINER
SET search_path = pg_catalog, public, extensions
AS $sep16_recovery273_archive_valid$
DECLARE
  v_audit public.lab_arena_sep16_baseline_recovery273_audit%ROWTYPE;
  v_runs_hash TEXT;
  v_ledger_hash TEXT;
  v_submission_doc JSONB;
BEGIN
  SELECT * INTO v_audit
  FROM public.lab_arena_sep16_baseline_recovery273_audit
...
END;
$sep16_recovery273_archive_valid$;
ALTER FUNCTION public.lab_arena_sep16_recovery273_archive_valid_v1()
  OWNER TO lab_arena_owner;
REVOKE ALL ON FUNCTION public.lab_arena_sep16_recovery273_archive_valid_v1()
  FROM PUBLIC, anon, authenticated, service_role, lab_arena_service;

CREATE OR REPLACE FUNCTION public.lab_arena_prepare_sep16_baseline_recovery273_v1(
...
SET search_path = pg_catalog, public, extensions
AS $prepare_sep16_baseline_recovery273$
DECLARE
...
BEGIN
  ...
  IF p_source_size_bytes IS DISTINCT FROM
    ...
    RAISE EXCEPTION 'Sep16 recovery273 source differs from authority'
      USING ERRCODE = '22023';
  END IF;
  IF p_forward_schedule IS DISTINCT FROM v_authority.forward_schedule THEN
    RAISE EXCEPTION 'Sep16 recovery273 schedule differs from authority'
      USING ERRCODE = '22023';
  END IF;
  LOCK TABLE public.lab_arena_sep16_baseline_recovery273_audit
    ...
    IF v_audit.archive_round_id <> v_authority.archive_round_id
       ...
       OR (SELECT pg_catalog.count(DISTINCT assignment_id)
           ...
           WHERE round_id = v_round_id AND submission_id = v_baseline_id
             AND kind = 'execute' AND assignment_id LIKE '%:rerun273') <> 20 THEN
      RAISE EXCEPTION 'Sep16 recovery273 replay differs' USING ERRCODE = '55000';
    END IF;
  ...
  IF v_round_hash <> v_authority.terminal_round_hash
    ...
    RAISE EXCEPTION 'Sep16 terminal rerun changed before recovery273'
      USING ERRCODE = '55000';
  END IF;
  INSERT INTO public.lab_arena_sep16_baseline_recovery273_audit (
    round_id, archive_round_id, archive_submission_id, execute_namespace,
  ...
  IF v_count <> v_authority.terminal_baseline_run_count THEN
    RAISE EXCEPTION 'Sep16 recovery273 archive run count differs';
  END IF;
  ...
  IF v_count <> v_authority.terminal_baseline_ledger_count THEN
    RAISE EXCEPTION 'Sep16 recovery273 archive ledger count differs';
  END IF;
  ...
  WHERE submission_id = v_baseline_id AND round_id = v_round_id;
  IF NOT FOUND THEN
    RAISE EXCEPTION 'Sep16 recovery273 baseline source switch failed';
  END IF;
  ...
  IF (v_new_configuration - 'schedule') IS DISTINCT FROM
    ...
    RAISE EXCEPTION 'Sep16 recovery273 changed frozen configuration';
  END IF;
  ...
  FOR v_position IN 0 .. 19 LOOP
    ...
    v_assignment := v_round_id || ':' || v_baseline_id || ':' ||
      v_stage::TEXT || ':' || v_position::TEXT || ':rerun273';
  ...
  IF NOT public.lab_arena_sep16_recovery273_archive_valid_v1()
     OR NOT public.lab_arena_sep16_recovery_archive_valid_v1()
     OR NOT public.lab_arena_sep16_recovery272_archive_valid_v1()
     OR NOT public.lab_arena_sep16_challenger_seals_valid_v1()
     OR (SELECT pg_catalog.count(*)
     ...
     OR (SELECT pg_catalog.count(*) FROM public.lab_arena_runs
         WHERE round_id = v_round_id AND submission_id = v_baseline_id
           ...
           AND assignment_id LIKE '%:rerun273') <> 20
     OR (SELECT pg_catalog.count(DISTINCT assignment_id)
         FROM public.lab_arena_runs
    ...
    RAISE EXCEPTION 'Sep16 recovery273 post-archive verification differs: %',
      pg_catalog.jsonb_build_object(
        'archive_valid', public.lab_arena_sep16_recovery273_archive_valid_v1(),
        ...
        'pending_recovery', (SELECT pg_catalog.count(*)
          FROM public.lab_arena_runs WHERE round_id = v_round_id
            ...
            AND status = 'pending' AND assignment_id LIKE '%:rerun273'),
...
END;
$prepare_sep16_baseline_recovery273$;
ALTER FUNCTION public.lab_arena_prepare_sep16_baseline_recovery273_v1(
  BIGINT, TEXT, TEXT, JSONB
)
  OWNER TO lab_arena_owner;
REVOKE ALL ON FUNCTION public.lab_arena_prepare_sep16_baseline_recovery273_v1(
  BIGINT, TEXT, TEXT, JSONB
)
  FROM PUBLIC, anon, authenticated, service_role, lab_arena_service;
GRANT EXECUTE ON FUNCTION public.lab_arena_prepare_sep16_baseline_recovery273_v1(
  BIGINT, TEXT, TEXT, JSONB
)
...
DO $replace_sep16_recovery273_namespaces$
DECLARE
  v_proc REGPROCEDURE;
  v_definition TEXT;
  v_old_count INTEGER;
...
BEGIN
  FOREACH v_proc IN ARRAY ARRAY[
    ...
    IF v_old_count = v_expected_count AND v_new_count = 0 THEN
      EXECUTE pg_catalog.replace(v_definition, ':rerun272', ':rerun273');
    ELSIF NOT (
  ...
  END LOOP;
END;
$replace_sep16_recovery273_namespaces$;

DO $bind_sep16_recovery273_archive_guard$
DECLARE
  v_definition TEXT;
  v_old TEXT := $old$OR NOT public.lab_arena_sep16_recovery_archive_valid_v1()
       OR NOT public.lab_arena_sep16_recovery272_archive_valid_v1()$old$;
  v_new TEXT := $new$OR NOT public.lab_arena_sep16_recovery_archive_valid_v1()
       OR NOT public.lab_arena_sep16_recovery272_archive_valid_v1()
       OR NOT public.lab_arena_sep16_recovery273_archive_valid_v1()$new$;
  v_old_count INTEGER;
  v_new_count INTEGER;
...
BEGIN
  ...
  ELSIF NOT (v_new_count = 1 AND v_new_function_count = 1) THEN
    RAISE EXCEPTION 'Sep16 publication recovery273 guard shape differs'
      USING ERRCODE = '55000';
  END IF;
  SELECT pg_catalog.pg_get_functiondef(
    'public.lab_arena_sep16_rerun_publication_guard_v1()'::REGPROCEDURE
  ...
  IF v_old_count <> 1 OR v_new_count <> 1
     OR v_base_function_count <> 1 OR v_prior_function_count <> 1
     OR v_new_function_count <> 1 THEN
    RAISE EXCEPTION 'Sep16 publication recovery273 guard binding failed'
      USING ERRCODE = '55000';
  END IF;
END;
$bind_sep16_recovery273_archive_guard$;
