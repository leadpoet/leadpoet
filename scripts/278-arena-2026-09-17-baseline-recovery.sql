...
BEGIN
  IF pg_catalog.to_regprocedure(
    ...
    RAISE EXCEPTION 'apply current Arena schema before recovery278';
  END IF;
END;
$requires_sep17_recovery278$;

GRANT CREATE ON SCHEMA public TO lab_arena_owner;

CREATE TABLE IF NOT EXISTS public.lab_arena_sep17_baseline_recovery278_authority (
  round_id TEXT PRIMARY KEY CHECK (round_id = 'arena-2026-09-17'),
  archive_round_id TEXT NOT NULL UNIQUE CHECK (
    archive_round_id = 'arena-2026-09-17-archive'
  ),
  archive_submission_id TEXT NOT NULL UNIQUE CHECK (
    archive_submission_id = 'baseline-2026-09-17-archive'
  ),
  execute_namespace TEXT NOT NULL CHECK (execute_namespace = 'rerun278'),
  terminal_source_ref TEXT NOT NULL CHECK (
    terminal_source_ref =
      'arena/arena-2026-09-17/sources/baseline-2026-09-17.tar.gz'
  ),
  ...
  terminal_source_sha256 TEXT NOT NULL CHECK (
    terminal_source_sha256 =
      '858ad5b2e68e3c6c354c0e4e358264186cec206b83220a68719a6e217273d057'
  ),
  ...
  recovery_source_size_bytes BIGINT NOT NULL CHECK (
    recovery_source_size_bytes = 562595
  ),
  recovery_source_sha256 TEXT NOT NULL CHECK (
    recovery_source_sha256 = '8dc02f198bc4c5e5780236f079efb789aace28f5acbd54af2a512c45f6fb5ed1'
  ),
  recovery_source_commit TEXT NOT NULL CHECK (
    recovery_source_commit = 'db54c917925cc4a9ba953eb64c604a38c2c803b1'
  ),
  ...
  terminal_round_hash TEXT NOT NULL CHECK (
    terminal_round_hash =
      'sha256:44e90be39654debd5f4051f1943b8a6880f268d7179078eabf678443fc3bbed7'
  ),
  terminal_baseline_submission_hash TEXT NOT NULL CHECK (
    terminal_baseline_submission_hash =
      'sha256:652742ab4ebbcc986fa22a28b47d421aee0b3c5a88ec0f34a03645c47781042e'
  ),
  terminal_baseline_runs_hash TEXT NOT NULL CHECK (
    terminal_baseline_runs_hash =
      'sha256:a462f1b0d6358e5add6382b9473e2bcc5f916f77a88391c74193b08f9c9426b0'
  ),
  terminal_baseline_ledger_hash TEXT NOT NULL CHECK (
    terminal_baseline_ledger_hash =
      'sha256:89a3eeb07eea0f05c5b9f1f6e7c711bcdfc4b139dacb3115af0583d4806e0746'
  ),
  ...
  terminal_submissions_hash TEXT NOT NULL CHECK (
    terminal_submissions_hash =
      'sha256:51e322f35a56def5374d3841b9d8db5c7b315703a57fee3c493128597ccf6e2d'
  ),
  ...
  terminal_baseline_ledger_count BIGINT NOT NULL CHECK (
    terminal_baseline_ledger_count = 2047
  ),
  ...
  terminal_baseline_ledger_max_entry_id BIGINT NOT NULL CHECK (
    terminal_baseline_ledger_max_entry_id = 459452
  ),
  terminal_baseline_settled_microusd BIGINT NOT NULL CHECK (
    terminal_baseline_settled_microusd = 5648508
  ),
  terminal_baseline_uncertain_microusd BIGINT NOT NULL CHECK (
    terminal_baseline_uncertain_microusd = 74326531
  ),
  ...
  terminal_execute_cost_doc JSONB NOT NULL CHECK (
    terminal_execute_cost_doc =
      $execute_cost${"call_count":783,"inflight_calls":0,"refused_calls":151,"reserved_or_uncertain_microusd":74326531,"settled_microusd":5648508,"success_unresolved_calls":0,"success_unresolved_microusd":0,"successful_calls":598,"successful_microusd":5648508,"uncertain_calls":29}$execute_cost$::JSONB
  ),
  ...
  terminal_status_generation BIGINT NOT NULL CHECK (
    terminal_status_generation = 3
  ),
  terminal_stage_generation BIGINT NOT NULL CHECK (
    terminal_stage_generation = 2
  ),
  ...
  old_schedule JSONB NOT NULL CHECK (
    old_schedule = $old_schedule${"benchmark_deadline":"2026-09-17T00:30:00Z","final_scoring_close":"2026-09-17T20:30:02Z","publication_deadline":"2026-09-17T20:30:03Z","stage_1_close":"2026-09-17T04:30:01Z","stage_1_scoring_close":"2026-09-17T11:00:01Z","stage_1_start":"2026-09-17T00:30:01Z","stage_2_close":"2026-09-17T14:00:02Z","stage_2_start":"2026-09-17T11:00:02Z","submission_cutoff":"2026-09-17T00:00:00Z","submission_open":"2026-09-16T00:00:00Z"}$old_schedule$::JSONB
  ),
  forward_schedule JSONB NOT NULL CHECK (
    forward_schedule = $new_schedule${"benchmark_deadline":"2026-09-17T06:00:00Z","final_scoring_close":"2026-09-17T16:20:00Z","publication_deadline":"2026-09-17T16:50:00Z","stage_1_close":"2026-09-17T12:00:00Z","stage_1_scoring_close":"2026-09-17T14:00:00Z","stage_1_start":"2026-09-17T06:00:01Z","stage_2_close":"2026-09-17T14:20:00Z","stage_2_start":"2026-09-17T14:00:01Z","submission_cutoff":"2026-09-17T00:00:00Z","submission_open":"2026-09-16T00:00:00Z"}$new_schedule$::JSONB
  ),
...
REVOKE ALL ON public.lab_arena_sep17_baseline_recovery278_authority
  FROM PUBLIC, anon, authenticated, service_role, lab_arena_service;

CREATE TABLE IF NOT EXISTS public.lab_arena_sep17_baseline_recovery278_audit (
  round_id TEXT PRIMARY KEY CHECK (round_id = 'arena-2026-09-17'),
...
ALTER TABLE public.lab_arena_sep17_baseline_recovery278_audit
  OWNER TO lab_arena_owner;
ALTER TABLE public.lab_arena_sep17_baseline_recovery278_audit
  ENABLE ROW LEVEL SECURITY;
REVOKE ALL ON public.lab_arena_sep17_baseline_recovery278_audit
  FROM PUBLIC, anon, authenticated, service_role, lab_arena_service;

INSERT INTO public.lab_arena_sep17_baseline_recovery278_authority (
  ...
  'arena-2026-09-17', 'arena-2026-09-17-archive',
  'baseline-2026-09-17-archive', 'rerun278',
  'arena/arena-2026-09-17/sources/baseline-2026-09-17.tar.gz',
  547308,
  '858ad5b2e68e3c6c354c0e4e358264186cec206b83220a68719a6e217273d057',
  'ec4887f728b77002de570c4023415f8963995b79',
  'arena/arena-2026-09-17/sources/baseline-2026-09-17-recovery278.tar.gz',
  562595, '8dc02f198bc4c5e5780236f079efb789aace28f5acbd54af2a512c45f6fb5ed1',
  ...
  'sha256:51e322f35a56def5374d3841b9d8db5c7b315703a57fee3c493128597ccf6e2d',
  'sha256:7c0d8883f0984000ea0fa2a30726fb489f959b3ce484b8dd5d40d79596684be6',
  40, 2047, 15, 453599, 459452, 5648508, 74326531, 9, 8,
  $execute_cost${"call_count":783,"inflight_calls":0,"refused_calls":151,"reserved_or_uncertain_microusd":74326531,"settled_microusd":5648508,"success_unresolved_calls":0,"success_unresolved_microusd":0,"successful_calls":598,"successful_microusd":5648508,"uncertain_calls":29}$execute_cost$::JSONB,
  $score_cost${"call_count":0,"inflight_calls":0,"refused_calls":0,"reserved_or_uncertain_microusd":0,"settled_microusd":0,"success_unresolved_calls":0,"success_unresolved_microusd":0,"successful_calls":0,"successful_microusd":0,"uncertain_calls":0}$score_cost$::JSONB,
  3, 2, 'execution_incomplete:stage1:20',
  $old_schedule${"benchmark_deadline":"2026-09-17T00:30:00Z","final_scoring_close":"2026-09-17T20:30:02Z","publication_deadline":"2026-09-17T20:30:03Z","stage_1_close":"2026-09-17T04:30:01Z","stage_1_scoring_close":"2026-09-17T11:00:01Z","stage_1_start":"2026-09-17T00:30:01Z","stage_2_close":"2026-09-17T14:00:02Z","stage_2_start":"2026-09-17T11:00:02Z","submission_cutoff":"2026-09-17T00:00:00Z","submission_open":"2026-09-16T00:00:00Z"}$old_schedule$::JSONB,
  $new_schedule${"benchmark_deadline":"2026-09-17T06:00:00Z","final_scoring_close":"2026-09-17T16:20:00Z","publication_deadline":"2026-09-17T16:50:00Z","stage_1_close":"2026-09-17T12:00:00Z","stage_1_scoring_close":"2026-09-17T14:00:00Z","stage_1_start":"2026-09-17T06:00:01Z","stage_2_close":"2026-09-17T14:20:00Z","stage_2_start":"2026-09-17T14:00:01Z","submission_cutoff":"2026-09-17T00:00:00Z","submission_open":"2026-09-16T00:00:00Z"}$new_schedule$::JSONB
) ON CONFLICT (round_id) DO NOTHING;

CREATE OR REPLACE FUNCTION public.lab_arena_sep17_recovery278_terminal_valid_v1()
RETURNS BOOLEAN
LANGUAGE plpgsql STABLE SECURITY DEFINER
SET search_path = pg_catalog, public, extensions
AS $sep17_recovery278_terminal_valid$
DECLARE
  v_authority public.lab_arena_sep17_baseline_recovery278_authority%ROWTYPE;
...
BEGIN
  ...
  FROM public.lab_arena_sep17_baseline_recovery278_authority
  ...
  RETURN v_round_hash IS NOT DISTINCT FROM v_authority.terminal_round_hash
     ...
     AND v_round.configuration_doc #>> '{call_quotas,openrouter}' = '60'
...
END;
$sep17_recovery278_terminal_valid$;
ALTER FUNCTION public.lab_arena_sep17_recovery278_terminal_valid_v1()
  OWNER TO lab_arena_owner;
REVOKE ALL ON FUNCTION public.lab_arena_sep17_recovery278_terminal_valid_v1()
  FROM PUBLIC, anon, authenticated, service_role, lab_arena_service;
...
LANGUAGE plpgsql STABLE SECURITY DEFINER
SET search_path = pg_catalog, public, extensions
AS $sep17_recovery278_nonbaseline_ledger_valid$
DECLARE
  v_authority public.lab_arena_sep17_baseline_recovery278_authority%ROWTYPE;
  v_hash TEXT;
  v_count BIGINT;
...
END;
$sep17_recovery278_nonbaseline_ledger_valid$;
ALTER FUNCTION
public.lab_arena_sep17_recovery278_nonbaseline_ledger_valid_v1()
  OWNER TO lab_arena_owner;
...
CREATE OR REPLACE FUNCTION public.lab_arena_sep17_recovery278_archive_valid_v1()
RETURNS BOOLEAN
LANGUAGE plpgsql STABLE SECURITY DEFINER
SET search_path = pg_catalog, public, extensions
AS $sep17_recovery278_archive_valid$
DECLARE
  v_audit public.lab_arena_sep17_baseline_recovery278_audit%ROWTYPE;
...
BEGIN
  SELECT * INTO v_audit
  FROM public.lab_arena_sep17_baseline_recovery278_audit
  WHERE round_id = 'arena-2026-09-17';
  ...
  RETURN v_runs_hash IS NOT DISTINCT FROM v_audit.terminal_baseline_runs_hash
     ...
     AND v_archive_round.cancel_reason =
          'authorized_sep17_failed_baseline_archive'
...
END;
$sep17_recovery278_archive_valid$;
ALTER FUNCTION public.lab_arena_sep17_recovery278_archive_valid_v1()
  OWNER TO lab_arena_owner;
REVOKE ALL ON FUNCTION public.lab_arena_sep17_recovery278_archive_valid_v1()
  FROM PUBLIC, anon, authenticated, service_role, lab_arena_service;

DO $verify_sep17_recovery278_terminal$
BEGIN
  IF EXISTS (
       SELECT 1 FROM public.lab_arena_sep17_baseline_recovery278_audit
       WHERE round_id = 'arena-2026-09-17'
     ) THEN
    IF public.lab_arena_sep17_recovery278_archive_valid_v1() IS NOT TRUE
       OR public.lab_arena_sep17_recovery278_nonbaseline_ledger_valid_v1()
            IS NOT TRUE THEN
      RAISE EXCEPTION 'Sep17 recovery278 archive seal differs'
        USING ERRCODE = '55000';
    END IF;
  ELSIF public.lab_arena_sep17_recovery278_terminal_valid_v1() IS NOT TRUE THEN
    RAISE EXCEPTION 'Sep17 cancelled baseline terminal seal differs'
      USING ERRCODE = '55000';
  END IF;
END;
$verify_sep17_recovery278_terminal$;

CREATE OR REPLACE FUNCTION public.lab_arena_prepare_sep17_baseline_recovery278_v1(
...
SET search_path = pg_catalog, public, extensions
AS $prepare_sep17_baseline_recovery278$
DECLARE
...
BEGIN
  ...
  IF p_source_size_bytes IS DISTINCT FROM
    ...
    RAISE EXCEPTION 'Sep17 recovery278 source, bank, or schedule differs'
      USING ERRCODE = '22023';
  END IF;
  ...
  IF FOUND THEN
    ...
    IF public.lab_arena_sep17_recovery278_archive_valid_v1() IS NOT TRUE
       ...
       OR v_nonbaseline_submissions_hash IS DISTINCT FROM
            v_authority.terminal_nonbaseline_submissions_hash
       THEN
      RAISE EXCEPTION 'Sep17 recovery278 replay differs' USING ERRCODE = '55000';
    END IF;
  ...
  IF pg_catalog.jsonb_typeof(p_forward_schedule) IS DISTINCT FROM 'object'
    ...
    RAISE EXCEPTION 'Sep17 recovery278 forward schedule invalid'
      USING ERRCODE = '22023';
  END IF;
  IF public.lab_arena_sep17_recovery278_terminal_valid_v1() IS NOT TRUE THEN
    RAISE EXCEPTION 'Sep17 cancelled baseline terminal seal differs'
      USING ERRCODE = '55000';
  END IF;
  ...
  INSERT INTO public.lab_arena_sep17_baseline_recovery278_audit (
    round_id, archive_round_id, archive_submission_id, execute_namespace,
  ...
  IF (v_new_configuration - 'schedule' - 'call_quotas') IS DISTINCT FROM
     ...
     OR v_new_configuration -> 'scoring_call_quotas' IS DISTINCT FROM
        v_round.configuration_doc -> 'scoring_call_quotas' THEN
    RAISE EXCEPTION 'Sep17 recovery278 changed frozen configuration';
  END IF;
  SELECT pg_catalog.jsonb_agg(
    CASE WHEN item ->> 'submission_id' = v_baseline_id THEN
      item || pg_catalog.jsonb_build_object(
  ...
  FROM pg_catalog.jsonb_populate_record(
    ...
    pg_catalog.to_jsonb(v_round) || pg_catalog.jsonb_build_object(
      ...
      'rewards_enabled', FALSE,
      'cancel_reason', 'authorized_sep17_failed_baseline_archive'
    )
  ) AS row_value;
  ...
  IF v_count <> v_authority.terminal_baseline_run_count THEN
    RAISE EXCEPTION 'Sep17 recovery278 run archive count differs';
  END IF;
  ...
  IF v_count <> v_authority.terminal_baseline_ledger_count THEN
    RAISE EXCEPTION 'Sep17 recovery278 ledger archive count differs';
  END IF;
  ...
  WHERE round_id = v_round_id AND submission_id = v_baseline_id;
  IF NOT FOUND THEN
    RAISE EXCEPTION 'Sep17 recovery278 baseline update differs';
  END IF;
  ...
  FOR v_position IN 0 .. 19 LOOP
    ...
    v_assignment := v_round_id || ':' || v_baseline_id || ':' ||
      v_stage::TEXT || ':' || v_position::TEXT || ':rerun278';
...
END;
$prepare_sep17_baseline_recovery278$;
ALTER FUNCTION public.lab_arena_prepare_sep17_baseline_recovery278_v1(
  BIGINT, TEXT, TEXT, TEXT, JSONB
)
  OWNER TO lab_arena_owner;
REVOKE ALL ON FUNCTION public.lab_arena_prepare_sep17_baseline_recovery278_v1(
  BIGINT, TEXT, TEXT, TEXT, JSONB
)
  FROM PUBLIC, anon, authenticated, service_role, lab_arena_service;
GRANT EXECUTE ON FUNCTION public.lab_arena_prepare_sep17_baseline_recovery278_v1(
  BIGINT, TEXT, TEXT, TEXT, JSONB
)
  TO lab_arena_service;

CREATE OR REPLACE FUNCTION public.lab_arena_sep17_recovery278_archive_guard_v1()
RETURNS TRIGGER
LANGUAGE plpgsql SECURITY DEFINER
SET search_path = pg_catalog, public, extensions
AS $sep17_recovery278_archive_guard$
BEGIN
  IF NEW.round_id = 'arena-2026-09-17'
     ...
     AND public.lab_arena_sep17_recovery278_archive_valid_v1() IS NOT TRUE THEN
    RAISE EXCEPTION 'Sep17 recovery278 archive seal differs'
      USING ERRCODE = '55000';
  END IF;
  RETURN NEW;
END;
$sep17_recovery278_archive_guard$;
ALTER FUNCTION public.lab_arena_sep17_recovery278_archive_guard_v1()
  OWNER TO lab_arena_owner;
REVOKE ALL ON FUNCTION public.lab_arena_sep17_recovery278_archive_guard_v1()
  FROM PUBLIC, anon, authenticated, service_role, lab_arena_service;
DROP TRIGGER IF EXISTS lab_arena_sep17_recovery278_archive_guard
  ON public.lab_arena_rounds;
CREATE TRIGGER lab_arena_sep17_recovery278_archive_guard
BEFORE UPDATE ON public.lab_arena_rounds
FOR EACH ROW EXECUTE FUNCTION
  public.lab_arena_sep17_recovery278_archive_guard_v1();
