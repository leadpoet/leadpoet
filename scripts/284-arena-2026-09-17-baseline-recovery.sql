...
BEGIN
  IF pg_catalog.to_regprocedure(
    ...
    RAISE EXCEPTION 'apply current Arena schema before recovery284';
  END IF;
END;
$requires_sep17_recovery284$;

GRANT CREATE ON SCHEMA public TO lab_arena_owner;

CREATE TABLE IF NOT EXISTS public.lab_arena_sep17_baseline_recovery284_authority (
  round_id TEXT PRIMARY KEY CHECK (round_id = 'arena-2026-09-17'),
  archive_round_id TEXT NOT NULL UNIQUE CHECK (
    archive_round_id = 'arena-2026-09-17-rerun283archive'
  ),
  archive_submission_id TEXT NOT NULL UNIQUE CHECK (
    archive_submission_id = 'baseline-2026-09-17-rerun283archive'
  ),
  execute_namespace TEXT NOT NULL CHECK (execute_namespace = 'rerun284'),
  ...
  terminal_source_size_bytes BIGINT NOT NULL CHECK (
    terminal_source_size_bytes = 581173
  ),
  terminal_source_sha256 TEXT NOT NULL CHECK (
    terminal_source_sha256 =
      '7df255f5db5267b13a65c9c3476cb47fd84837e00ce503bd1f588585ee8a37ae'
  ),
  terminal_source_commit TEXT NOT NULL CHECK (
    terminal_source_commit = 'e40484afde214a417128d1eadacaff716755784f'
  ),
  ...
  recovery_source_size_bytes BIGINT NOT NULL CHECK (
    recovery_source_size_bytes = 582191
  ),
  recovery_source_sha256 TEXT NOT NULL CHECK (
    recovery_source_sha256 = 'b5ca95d7c9c25650c5ecb04b05bde859cffa3fe9c6c7a6602e6a006d5e3dcd99'
  ),
  recovery_source_commit TEXT NOT NULL CHECK (
    recovery_source_commit = '91e8b95637c4cbc919f3150d6643985624dbb34a'
  ),
  ...
  terminal_round_hash TEXT NOT NULL CHECK (
    terminal_round_hash =
      'sha256:0ecee1f1da0caccd2557e31dd6daf2acfcbe59443168412f677805b1466e1e55'
  ),
  terminal_baseline_submission_hash TEXT NOT NULL CHECK (
    terminal_baseline_submission_hash =
      'sha256:27db092c93d829f66cc287a2ae8eb9af376e95c92f105cd8f2bceb827fd00915'
  ),
  terminal_baseline_runs_hash TEXT NOT NULL CHECK (
    terminal_baseline_runs_hash =
      'sha256:c441c08af1d7b4a0f05cdb60254760f071823e09b592e7d2f1b1a5ea50cbfa72'
  ),
  terminal_baseline_ledger_hash TEXT NOT NULL CHECK (
    terminal_baseline_ledger_hash =
      'sha256:2083d3d7df0a3e1e84b58e8c8612ce0a70839ba64c4c24a9b3472041bf6e58ac'
  ),
  ...
  terminal_submissions_hash TEXT NOT NULL CHECK (
    terminal_submissions_hash =
      'sha256:dfbbbe76adb9876829d086afc6a819ac22be972b5123a487f0ea3aa40923d91b'
  ),
  ...
  terminal_baseline_ledger_count BIGINT NOT NULL CHECK (
    terminal_baseline_ledger_count = 3964
  ),
  ...
  terminal_baseline_ledger_max_entry_id BIGINT NOT NULL CHECK (
    terminal_baseline_ledger_max_entry_id = 481774
  ),
  terminal_baseline_settled_microusd BIGINT NOT NULL CHECK (
    terminal_baseline_settled_microusd = 7373524
  ),
  terminal_baseline_uncertain_microusd BIGINT NOT NULL CHECK (
    terminal_baseline_uncertain_microusd = 7231386
  ),
  ...
  terminal_execute_cost_doc JSONB NOT NULL CHECK (
    terminal_execute_cost_doc =
      $execute_cost${"call_count":1321,"inflight_calls":0,"refused_calls":0,"reserved_or_uncertain_microusd":7174142,"settled_microusd":7373524,"success_unresolved_calls":0,"success_unresolved_microusd":0,"successful_calls":1281,"successful_microusd":7360546,"uncertain_calls":31}$execute_cost$::JSONB
  ),
  ...
  terminal_status_generation BIGINT NOT NULL CHECK (
    terminal_status_generation = 9
  ),
  terminal_stage_generation BIGINT NOT NULL CHECK (
    terminal_stage_generation = 8
  ),
  terminal_cancel_reason TEXT NOT NULL CHECK (
    terminal_cancel_reason = 'operator'
  ),
  old_schedule JSONB NOT NULL CHECK (
    old_schedule = $old_schedule${"benchmark_deadline":"2026-09-17T14:00:00Z","final_scoring_close":"2026-09-18T00:20:00Z","publication_deadline":"2026-09-18T00:50:00Z","stage_1_close":"2026-09-17T20:00:00Z","stage_1_scoring_close":"2026-09-17T22:00:00Z","stage_1_start":"2026-09-17T14:00:01Z","stage_2_close":"2026-09-17T22:20:00Z","stage_2_start":"2026-09-17T22:00:01Z","submission_cutoff":"2026-09-17T00:00:00Z","submission_open":"2026-09-16T00:00:00Z"}$old_schedule$::JSONB
  ),
...
ALTER TABLE public.lab_arena_sep17_baseline_recovery284_authority
  OWNER TO lab_arena_owner;
ALTER TABLE public.lab_arena_sep17_baseline_recovery284_authority
  ENABLE ROW LEVEL SECURITY;
REVOKE ALL ON public.lab_arena_sep17_baseline_recovery284_authority
  FROM PUBLIC, anon, authenticated, service_role, lab_arena_service;

CREATE TABLE IF NOT EXISTS public.lab_arena_sep17_baseline_recovery284_audit (
  round_id TEXT PRIMARY KEY CHECK (round_id = 'arena-2026-09-17'),
...
ALTER TABLE public.lab_arena_sep17_baseline_recovery284_audit
  OWNER TO lab_arena_owner;
ALTER TABLE public.lab_arena_sep17_baseline_recovery284_audit
  ENABLE ROW LEVEL SECURITY;
REVOKE ALL ON public.lab_arena_sep17_baseline_recovery284_audit
  FROM PUBLIC, anon, authenticated, service_role, lab_arena_service;

INSERT INTO public.lab_arena_sep17_baseline_recovery284_authority (
  ...
  'arena-2026-09-17', 'arena-2026-09-17-rerun283archive',
  'baseline-2026-09-17-rerun283archive', 'rerun284',
  'arena/arena-2026-09-17/sources/baseline-2026-09-17-recovery283.tar.gz',
  581173,
  '7df255f5db5267b13a65c9c3476cb47fd84837e00ce503bd1f588585ee8a37ae',
  'e40484afde214a417128d1eadacaff716755784f',
  'arena/arena-2026-09-17/sources/baseline-2026-09-17-recovery284.tar.gz',
  582191, 'b5ca95d7c9c25650c5ecb04b05bde859cffa3fe9c6c7a6602e6a006d5e3dcd99',
  ...
  9, 8,
  'operator',
  $old_schedule${"benchmark_deadline":"2026-09-17T14:00:00Z","final_scoring_close":"2026-09-18T00:20:00Z","publication_deadline":"2026-09-18T00:50:00Z","stage_1_close":"2026-09-17T20:00:00Z","stage_1_scoring_close":"2026-09-17T22:00:00Z","stage_1_start":"2026-09-17T14:00:01Z","stage_2_close":"2026-09-17T22:20:00Z","stage_2_start":"2026-09-17T22:00:01Z","submission_cutoff":"2026-09-17T00:00:00Z","submission_open":"2026-09-16T00:00:00Z"}$old_schedule$::JSONB,
  $new_schedule${"benchmark_deadline":"2026-09-17T14:00:00Z","final_scoring_close":"2026-09-18T00:20:00Z","publication_deadline":"2026-09-18T00:50:00Z","stage_1_close":"2026-09-17T20:00:00Z","stage_1_scoring_close":"2026-09-17T22:00:00Z","stage_1_start":"2026-09-17T14:00:01Z","stage_2_close":"2026-09-17T22:20:00Z","stage_2_start":"2026-09-17T22:00:01Z","submission_cutoff":"2026-09-17T00:00:00Z","submission_open":"2026-09-16T00:00:00Z"}$new_schedule$::JSONB
) ON CONFLICT (round_id) DO NOTHING;


-- Keep the already archived original attempt and its owner audit immutable.
CREATE OR REPLACE FUNCTION public.lab_arena_sep17_recovery284_prior_valid_v1()
RETURNS BOOLEAN LANGUAGE sql STABLE SECURITY DEFINER
SET search_path = pg_catalog, public, extensions
AS $sep17_recovery284_prior_valid$
  SELECT public.lab_arena_sep17_recovery283_archive_valid_v1() IS TRUE
    AND public.lab_arena_sep17_recovery283_nonbaseline_ledger_valid_v1() IS TRUE
    AND EXISTS (
      SELECT 1 FROM public.lab_arena_sep17_baseline_recovery283_authority AS prior
      WHERE round_id = 'arena-2026-09-17'
        AND 'sha256:' || pg_catalog.encode(extensions.digest(
          pg_catalog.to_jsonb(prior)::TEXT, 'sha256'), 'hex') =
            'sha256:a6ba78a021b6ce772e5842e6c259b5be545cf2ad323aceeade1971db309fb7a6'
    )
    AND EXISTS (
      SELECT 1 FROM public.lab_arena_sep17_baseline_recovery283_audit AS prior
      WHERE round_id = 'arena-2026-09-17'
        AND 'sha256:' || pg_catalog.encode(extensions.digest(
          pg_catalog.to_jsonb(prior)::TEXT, 'sha256'), 'hex') =
            'sha256:872115e1ff622ca29f67ca112a77bab4ac17284044d280b2efe1007b7e2ffcfb'
    );
$sep17_recovery284_prior_valid$;
ALTER FUNCTION public.lab_arena_sep17_recovery284_prior_valid_v1()
  OWNER TO lab_arena_owner;
REVOKE ALL ON FUNCTION public.lab_arena_sep17_recovery284_prior_valid_v1()
  FROM PUBLIC, anon, authenticated, service_role, lab_arena_service;

CREATE OR REPLACE FUNCTION public.lab_arena_sep17_recovery284_terminal_valid_v1()
RETURNS BOOLEAN
LANGUAGE plpgsql STABLE SECURITY DEFINER
SET search_path = pg_catalog, public, extensions
AS $sep17_recovery284_terminal_valid$
DECLARE
  v_authority public.lab_arena_sep17_baseline_recovery284_authority%ROWTYPE;
...
BEGIN
  ...
  FROM public.lab_arena_sep17_baseline_recovery284_authority
  WHERE round_id = 'arena-2026-09-17';
  ...
  RETURN public.lab_arena_sep17_recovery284_prior_valid_v1() IS TRUE
     ...
     AND (SELECT pg_catalog.count(DISTINCT assignment_id)
          ...
          WHERE round_id = v_round.round_id AND submission_id = v_baseline.submission_id
            AND kind = 'execute' AND assignment_id LIKE '%:rerun283') = 20
     AND NOT EXISTS (
...
END;
$sep17_recovery284_terminal_valid$;
ALTER FUNCTION public.lab_arena_sep17_recovery284_terminal_valid_v1()
  OWNER TO lab_arena_owner;
REVOKE ALL ON FUNCTION public.lab_arena_sep17_recovery284_terminal_valid_v1()
  FROM PUBLIC, anon, authenticated, service_role, lab_arena_service;
...
LANGUAGE plpgsql STABLE SECURITY DEFINER
SET search_path = pg_catalog, public, extensions
AS $sep17_recovery284_nonbaseline_ledger_valid$
DECLARE
  v_authority public.lab_arena_sep17_baseline_recovery284_authority%ROWTYPE;
  v_hash TEXT;
  v_count BIGINT;
...
END;
$sep17_recovery284_nonbaseline_ledger_valid$;
ALTER FUNCTION
public.lab_arena_sep17_recovery284_nonbaseline_ledger_valid_v1()
  OWNER TO lab_arena_owner;
...
CREATE OR REPLACE FUNCTION public.lab_arena_sep17_recovery284_archive_valid_v1()
RETURNS BOOLEAN
LANGUAGE plpgsql STABLE SECURITY DEFINER
SET search_path = pg_catalog, public, extensions
AS $sep17_recovery284_archive_valid$
DECLARE
  v_audit public.lab_arena_sep17_baseline_recovery284_audit%ROWTYPE;
...
BEGIN
  SELECT * INTO v_audit
  FROM public.lab_arena_sep17_baseline_recovery284_audit
  WHERE round_id = 'arena-2026-09-17';
  ...
  RETURN public.lab_arena_sep17_recovery284_prior_valid_v1() IS TRUE
     ...
     AND v_archive_round.cancel_reason =
          'authorized_sep17_recovery283_baseline_archive'
...
END;
$sep17_recovery284_archive_valid$;
ALTER FUNCTION public.lab_arena_sep17_recovery284_archive_valid_v1()
  OWNER TO lab_arena_owner;
REVOKE ALL ON FUNCTION public.lab_arena_sep17_recovery284_archive_valid_v1()
  FROM PUBLIC, anon, authenticated, service_role, lab_arena_service;

DO $verify_sep17_recovery284_terminal$
BEGIN
  IF EXISTS (
       SELECT 1 FROM public.lab_arena_sep17_baseline_recovery284_audit
       WHERE round_id = 'arena-2026-09-17'
     ) THEN
    IF public.lab_arena_sep17_recovery284_archive_valid_v1() IS NOT TRUE
       OR public.lab_arena_sep17_recovery284_nonbaseline_ledger_valid_v1()
            IS NOT TRUE THEN
      RAISE EXCEPTION 'Sep17 recovery284 archive seal differs'
        USING ERRCODE = '55000';
    END IF;
  ELSIF public.lab_arena_sep17_recovery284_terminal_valid_v1() IS NOT TRUE THEN
    RAISE EXCEPTION 'Sep17 cancelled baseline terminal seal differs'
      USING ERRCODE = '55000';
  END IF;
END;
$verify_sep17_recovery284_terminal$;

CREATE OR REPLACE FUNCTION public.lab_arena_prepare_sep17_baseline_recovery284_v1(
...
SET search_path = pg_catalog, public, extensions
AS $prepare_sep17_baseline_recovery284$
DECLARE
...
BEGIN
  ...
  PERFORM pg_catalog.pg_advisory_xact_lock(
    pg_catalog.hashtextextended('arena-2026-09-17-baseline-recovery284', 0)
  );
  ...
  IF p_source_size_bytes IS DISTINCT FROM
    ...
    RAISE EXCEPTION 'Sep17 recovery284 source, bank, or schedule differs'
      USING ERRCODE = '22023';
  END IF;
  LOCK TABLE public.lab_arena_sep17_baseline_recovery284_audit
  ...
  IF FOUND THEN
    ...
    IF public.lab_arena_sep17_recovery284_archive_valid_v1() IS NOT TRUE
       ...
       OR (SELECT pg_catalog.count(DISTINCT assignment_id)
           ...
           WHERE round_id = v_round_id AND submission_id = v_baseline_id
             AND kind = 'execute'
             AND assignment_id LIKE '%:rerun284') <> 20
       OR EXISTS (
         SELECT 1 FROM public.lab_arena_runs
         WHERE round_id = v_round_id AND submission_id = v_baseline_id
       ...
       OR v_nonbaseline_submissions_hash IS DISTINCT FROM
            v_authority.terminal_nonbaseline_submissions_hash
       THEN
      RAISE EXCEPTION 'Sep17 recovery284 replay differs' USING ERRCODE = '55000';
    END IF;
  ...
  IF pg_catalog.jsonb_typeof(p_forward_schedule) IS DISTINCT FROM 'object'
    ...
    RAISE EXCEPTION 'Sep17 recovery284 forward schedule invalid'
      USING ERRCODE = '22023';
  END IF;
  IF public.lab_arena_sep17_recovery284_terminal_valid_v1() IS NOT TRUE THEN
    RAISE EXCEPTION 'Sep17 cancelled baseline terminal seal differs'
      USING ERRCODE = '55000';
  END IF;
  ...
  INSERT INTO public.lab_arena_sep17_baseline_recovery284_audit (
    round_id, archive_round_id, archive_submission_id, execute_namespace,
  ...
  IF (v_new_configuration - 'schedule') IS DISTINCT FROM
    ...
    RAISE EXCEPTION 'Sep17 recovery284 changed frozen configuration';
  END IF;
  SELECT pg_catalog.jsonb_agg(
    CASE WHEN item ->> 'submission_id' = v_baseline_id THEN
      item || pg_catalog.jsonb_build_object(
  ...
  FROM pg_catalog.jsonb_populate_record(
    ...
    pg_catalog.to_jsonb(v_round) || pg_catalog.jsonb_build_object(
      ...
      'rewards_enabled', FALSE,
      'cancel_reason', 'authorized_sep17_recovery283_baseline_archive'
    )
  ) AS row_value;
  ...
  IF v_count <> v_authority.terminal_baseline_run_count THEN
    RAISE EXCEPTION 'Sep17 recovery284 run archive count differs';
  END IF;
  ...
  IF v_count <> v_authority.terminal_baseline_ledger_count THEN
    RAISE EXCEPTION 'Sep17 recovery284 ledger archive count differs';
  END IF;
  ...
  WHERE round_id = v_round_id AND submission_id = v_baseline_id;
  IF NOT FOUND THEN
    RAISE EXCEPTION 'Sep17 recovery284 baseline update differs';
  END IF;
  ...
  FOR v_position IN 0 .. 19 LOOP
    ...
    v_assignment := v_round_id || ':' || v_baseline_id || ':' ||
      v_stage::TEXT || ':' || v_position::TEXT || ':rerun284';
  ...
  IF public.lab_arena_sep17_recovery284_archive_valid_v1() IS NOT TRUE
    ...
    RAISE EXCEPTION 'Sep17 recovery284 postcondition differs';
  END IF;
  RETURN pg_catalog.jsonb_build_object(
...
END;
$prepare_sep17_baseline_recovery284$;
ALTER FUNCTION public.lab_arena_prepare_sep17_baseline_recovery284_v1(
  BIGINT, TEXT, TEXT, TEXT, JSONB
)
  OWNER TO lab_arena_owner;
REVOKE ALL ON FUNCTION public.lab_arena_prepare_sep17_baseline_recovery284_v1(
  BIGINT, TEXT, TEXT, TEXT, JSONB
)
  FROM PUBLIC, anon, authenticated, service_role, lab_arena_service;
GRANT EXECUTE ON FUNCTION public.lab_arena_prepare_sep17_baseline_recovery284_v1(
  BIGINT, TEXT, TEXT, TEXT, JSONB
)
  TO lab_arena_service;

CREATE OR REPLACE FUNCTION public.lab_arena_sep17_recovery284_archive_guard_v1()
RETURNS TRIGGER
LANGUAGE plpgsql SECURITY DEFINER
SET search_path = pg_catalog, public, extensions
AS $sep17_recovery284_archive_guard$
BEGIN
  IF NEW.round_id = 'arena-2026-09-17'
     ...
     AND public.lab_arena_sep17_recovery284_archive_valid_v1() IS NOT TRUE THEN
    RAISE EXCEPTION 'Sep17 recovery284 archive seal differs'
      USING ERRCODE = '55000';
  END IF;
  RETURN NEW;
END;
$sep17_recovery284_archive_guard$;
ALTER FUNCTION public.lab_arena_sep17_recovery284_archive_guard_v1()
  OWNER TO lab_arena_owner;
REVOKE ALL ON FUNCTION public.lab_arena_sep17_recovery284_archive_guard_v1()
  FROM PUBLIC, anon, authenticated, service_role, lab_arena_service;
DROP TRIGGER IF EXISTS lab_arena_sep17_recovery284_archive_guard
  ON public.lab_arena_rounds;
CREATE TRIGGER lab_arena_sep17_recovery284_archive_guard
BEFORE UPDATE ON public.lab_arena_rounds
FOR EACH ROW EXECUTE FUNCTION
  public.lab_arena_sep17_recovery284_archive_guard_v1();
