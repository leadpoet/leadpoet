-- Authorized Sep19 rerun313: exact terminal rerun310 seals, tested model and scorer.
-- Preserve historical attempts, charges, frozen miner executions, bank and rewards.
BEGIN;
...
CREATE OR REPLACE FUNCTION public.lab_arena_sep19_rerun313_archive_valid_v1()
RETURNS BOOLEAN LANGUAGE plpgsql STABLE SECURITY DEFINER
SET search_path=pg_catalog,public,extensions AS $archive313$
...
BEGIN
 ...
 RETURN archived.status='cancelled'
  ...
  AND archived.cancel_reason='authorized_sep19_terminal310_fixed_baseline_archive'
  AND archived.configuration_doc->>'archived_terminal_round_sha256'='afcc91227c86c7ae90a34254dd5bb25e5c1c117d9417d3c6303d3e930ed60324'
  AND archived.configuration_doc->>'archived_terminal_baseline_sha256'='4e17acc0ba6e9321fa5e626be9d209a0910dc29320ec69185506ac43aa954ecd'
  ...
  AND archived.configuration_doc->>'archived_terminal_runs_sha256'='e1929cdac5db67d597e36f3c714af3a5aed6ebd0a1b212464519964d841aa544'
  AND archived.configuration_doc->>'archived_terminal_ledger_sha256'='feef18663abba63b93d547dfeaeba62f9e177a9e57c8fccbb823165dd8d7ac63'
  ...
  AND pg_catalog.jsonb_array_length(derived)=101
  AND (SELECT pg_catalog.count(DISTINCT value->>'run_id')
       FROM pg_catalog.jsonb_array_elements(derived))=101
  AND (SELECT pg_catalog.count(*) FROM public.lab_arena_submissions
       WHERE round_id='arena-2026-09-19-r313archive')=5
  AND (SELECT pg_catalog.count(*) FROM public.lab_arena_runs
       WHERE round_id='arena-2026-09-19-r313archive' AND kind='execute'
        AND submission_id='baseline-2026-09-19:r313archive')=21
  AND NOT EXISTS(SELECT 1 FROM public.lab_arena_runs
       WHERE round_id='arena-2026-09-19-r313archive' AND kind='execute'
        AND submission_id='baseline-2026-09-19:r313archive'
        AND assignment_id NOT LIKE '%:rerun310')
  AND (SELECT pg_catalog.count(*) FROM public.lab_arena_runs
       WHERE round_id='arena-2026-09-19-r313archive' AND kind='score')=50
  AND NOT EXISTS(SELECT 1 FROM public.lab_arena_runs
       WHERE round_id='arena-2026-09-19-r313archive' AND kind='score'
        AND submission_id NOT LIKE '%:r313archive')
  AND NOT EXISTS(SELECT 1 FROM public.lab_arena_runs
       WHERE round_id='arena-2026-09-19-r313archive' AND kind='score'
        AND assignment_id NOT LIKE '%:score:rerun310')
  AND NOT EXISTS(SELECT 1 FROM public.lab_arena_ledger ledger
       WHERE ledger.round_id='arena-2026-09-19-r313archive'
        AND NOT EXISTS(SELECT 1 FROM public.lab_arena_runs run
          WHERE run.round_id='arena-2026-09-19-r313archive'
           AND run.run_id=ledger.run_id));
END $archive313$;
ALTER FUNCTION public.lab_arena_sep19_rerun313_archive_valid_v1()
 OWNER TO lab_arena_owner;
REVOKE ALL ON FUNCTION public.lab_arena_sep19_rerun313_archive_valid_v1()
 FROM PUBLIC,anon,authenticated,service_role,lab_arena_service;

CREATE OR REPLACE FUNCTION public.lab_arena_sep19_rerun313_active_valid_v1()
RETURNS BOOLEAN LANGUAGE plpgsql STABLE SECURITY DEFINER
SET search_path=pg_catalog,public AS $active313$
...
BEGIN
 ...
 RETURN active.round_id IS NOT NULL AND archived.round_id IS NOT NULL
  AND public.lab_arena_sep19_rerun313_archive_valid_v1() IS TRUE
  AND pg_catalog.encode(extensions.digest(pg_catalog.jsonb_build_object(
...
END $active313$;
ALTER FUNCTION public.lab_arena_sep19_rerun313_active_valid_v1()
 OWNER TO lab_arena_owner;
REVOKE ALL ON FUNCTION public.lab_arena_sep19_rerun313_active_valid_v1()
 FROM PUBLIC,anon,authenticated,service_role,lab_arena_service;

-- Replace the exact rerun310 guard and namespace in the current scorer. A
-- second stacked guard would reject rerun313 after the archive is created.
DO $patch_sep19_rerun313_scorer$
DECLARE definition TEXT; current_hash TEXT;
 old_assignment TEXT:=$assignment310$    IF p_round_id='arena-2026-09-19'
    ...
    END IF;
    v_status := CASE WHEN v_cache.cache_key IS NULL THEN 'pending' ELSE 'accepted' END;$assignment310$;
 old_guard TEXT:=$guard310$  IF p_round_id='arena-2026-09-19'
     AND EXISTS(SELECT 1 FROM public.lab_arena_rounds
...
BEGIN
 ...
 IF current_hash='bdc0225eff9be6e5386bf5a58780924523d01a7e416e559d9f5417821e2d6c3d' THEN
  IF (pg_catalog.length(definition)-pg_catalog.length(pg_catalog.replace(
   ...
   RAISE EXCEPTION 'Sep19 rerun313 scorer seam differs';
  END IF;
  ...
  EXECUTE definition;
 ELSIF current_hash<>'5fb72273dbd4aef5417bf89bbabb57cd55df7213feb5abd7ebbe4fc3482c573a' THEN
  RAISE EXCEPTION 'Sep19 rerun313 scorer definition differs';
 END IF;
 IF pg_catalog.encode(extensions.digest(pg_catalog.pg_get_functiondef(
   'public.lab_arena_open_scoring_v2(text,smallint,jsonb)'::pg_catalog.regprocedure),
   'sha256'),'hex')<>'5fb72273dbd4aef5417bf89bbabb57cd55df7213feb5abd7ebbe4fc3482c573a' THEN
  RAISE EXCEPTION 'Sep19 rerun313 scorer patch differs';
 END IF;
END $patch_sep19_rerun313_scorer$;

CREATE OR REPLACE FUNCTION public.lab_arena_prepare_sep19_rerun313_v1(
...
SET search_path=pg_catalog,public,extensions AS $prepare313$
DECLARE
...
BEGIN
 ...
 IF p_source_size_bytes<>788550
  ...
  OR p_schedule IS DISTINCT FROM '{"benchmark_deadline":"2026-09-19T11:35:14Z","final_scoring_close":"2026-09-19T23:35:14Z","publication_deadline":"2026-09-19T23:35:15Z","stage_1_close":"2026-09-19T14:35:15Z","stage_1_scoring_close":"2026-09-19T17:35:14Z","stage_1_start":"2026-09-19T11:35:15Z","stage_2_close":"2026-09-19T20:35:15Z","stage_2_start":"2026-09-19T17:35:15Z","submission_cutoff":"2026-09-19T00:00:00Z","submission_open":"2026-09-18T00:00:00Z"}'::JSONB
  ...
  RAISE EXCEPTION 'Sep19 rerun313 source, judge, bank, or schedule differs'
   USING ERRCODE='22023';
 END IF;
 PERFORM pg_catalog.pg_advisory_xact_lock(
  pg_catalog.hashtextextended('arena-2026-09-19-rerun313',0));
 ...
 IF EXISTS(SELECT 1 FROM public.lab_arena_rounds
   WHERE round_id='arena-2026-09-19-r313archive') THEN
  IF public.lab_arena_sep19_rerun313_archive_valid_v1() IS NOT TRUE
   OR public.lab_arena_sep19_rerun313_active_valid_v1() IS NOT TRUE THEN
   RAISE EXCEPTION 'existing Sep19 rerun313 differs' USING ERRCODE='55000';
  END IF;
  RETURN pg_catalog.jsonb_build_object('status','existing',
   'round_id','arena-2026-09-19','fresh_baseline_execute_count',20,
   'retained_miner_execute_count',80,'score_namespace','score:rerun313');
 END IF;
 IF (p_schedule->>'benchmark_deadline')::TIMESTAMPTZ<=pg_catalog.clock_timestamp() THEN
  RAISE EXCEPTION 'Sep19 rerun313 admission window closed' USING ERRCODE='22023';
 END IF;
 ...
 IF active_round.status NOT IN('published','cancelled') OR active_count<>0 OR unsettled<>0
  ...
  OR pg_catalog.encode(extensions.digest(pg_catalog.to_jsonb(active_round)::TEXT,
       'sha256'),'hex')<>'afcc91227c86c7ae90a34254dd5bb25e5c1c117d9417d3c6303d3e930ed60324'
  OR pg_catalog.encode(extensions.digest(pg_catalog.to_jsonb(active_baseline)::TEXT,
       'sha256'),'hex')<>'4e17acc0ba6e9321fa5e626be9d209a0910dc29320ec69185506ac43aa954ecd'
  OR (SELECT pg_catalog.count(*) FROM public.lab_arena_runs
      ...
      <>99
  OR (SELECT pg_catalog.count(*) FROM public.lab_arena_runs
      WHERE round_id='arena-2026-09-19' AND kind='execute')<>101
  OR (SELECT pg_catalog.count(*) FROM public.lab_arena_runs
      WHERE round_id='arena-2026-09-19' AND kind='score')<>50
  ...
  OR (SELECT pg_catalog.count(*) FROM public.lab_arena_runs
      WHERE round_id='arena-2026-09-19' AND kind='execute'
       AND submission_id='baseline-2026-09-19')<>21
  OR (SELECT pg_catalog.count(*) FROM public.lab_arena_runs
      WHERE round_id='arena-2026-09-19' AND kind='execute'
       AND submission_id<>'baseline-2026-09-19')<>80 THEN
  RAISE EXCEPTION 'Sep19 rerun313 terminal preimage differs' USING ERRCODE='55000';
 END IF;
 IF pg_catalog.encode(extensions.digest(COALESCE((SELECT pg_catalog.string_agg(
  ...
  OR pg_catalog.encode(extensions.digest(COALESCE((SELECT pg_catalog.string_agg(
      ...
      WHERE round_id='arena-2026-09-19'),''),'sha256'),'hex')<>'e1929cdac5db67d597e36f3c714af3a5aed6ebd0a1b212464519964d841aa544'
  OR pg_catalog.encode(extensions.digest(COALESCE((SELECT pg_catalog.string_agg(
      ...
      WHERE round_id='arena-2026-09-19'),''),'sha256'),'hex')<>'feef18663abba63b93d547dfeaeba62f9e177a9e57c8fccbb823165dd8d7ac63' THEN
  RAISE EXCEPTION 'Sep19 rerun313 terminal history differs' USING ERRCODE='55000';
 END IF;
 SELECT pg_catalog.jsonb_agg(pg_catalog.jsonb_build_object(
  ...
  WHERE round_id='arena-2026-09-19' AND kind='execute';
 IF pg_catalog.jsonb_array_length(derived)<>101 THEN
  RAISE EXCEPTION 'Sep19 rerun313 derived judgment count differs'; END IF;
 ...
 archive_participants:=(SELECT pg_catalog.jsonb_agg(
   item||pg_catalog.jsonb_build_object('submission_id',(item->>'submission_id')||':r313archive')
 ...
 archive_config:=active_round.configuration_doc||pg_catalog.jsonb_build_object(
  'round_id','arena-2026-09-19-r313archive','mode','shadow','rewards_enabled',FALSE,
  ...
  'archived_terminal_round_sha256','afcc91227c86c7ae90a34254dd5bb25e5c1c117d9417d3c6303d3e930ed60324',
  'archived_terminal_baseline_sha256','4e17acc0ba6e9321fa5e626be9d209a0910dc29320ec69185506ac43aa954ecd',
  'archived_terminal_miner_submissions_sha256','781027021d3cadc5f2c0540d9f24a67f65cb25126912ef3544867d5a70153297',
  'archived_terminal_runs_sha256','e1929cdac5db67d597e36f3c714af3a5aed6ebd0a1b212464519964d841aa544',
  'archived_terminal_ledger_sha256','feef18663abba63b93d547dfeaeba62f9e177a9e57c8fccbb823165dd8d7ac63',
 ...
 SELECT pg_catalog.jsonb_build_object(
  'rounds',(SELECT pg_catalog.jsonb_agg(pg_catalog.to_jsonb(r) ORDER BY round_id)
    FROM public.lab_arena_rounds r WHERE round_id NOT IN(
     'arena-2026-09-19','arena-2026-09-19-r313archive')),
 ...
 INSERT INTO public.lab_arena_rounds(
  ...
  NULL::public.lab_arena_rounds,pg_catalog.to_jsonb(active_round)||pg_catalog.jsonb_build_object(
   'round_id','arena-2026-09-19-r313archive','status','cancelled',
   ...
   'cancel_reason','authorized_sep19_terminal310_fixed_baseline_archive'));
 INSERT INTO public.lab_arena_submissions SELECT (pg_catalog.jsonb_populate_record(
  NULL::public.lab_arena_submissions,pg_catalog.to_jsonb(s)||pg_catalog.jsonb_build_object(
   'round_id','arena-2026-09-19-r313archive',
   'submission_id',s.submission_id||':r313archive'))).*
  FROM public.lab_arena_submissions s WHERE s.round_id='arena-2026-09-19';
 UPDATE public.lab_arena_runs SET round_id='arena-2026-09-19-r313archive',
  submission_id=submission_id||':r313archive'
  WHERE round_id='arena-2026-09-19' AND kind='score';
 GET DIAGNOSTICS moved_scores=ROW_COUNT;
 UPDATE public.lab_arena_ledger l SET round_id='arena-2026-09-19-r313archive',
  submission_id=submission_id||':r313archive'
  WHERE round_id='arena-2026-09-19' AND EXISTS(SELECT 1 FROM public.lab_arena_runs s
   WHERE s.round_id='arena-2026-09-19-r313archive' AND s.kind='score' AND s.run_id=l.run_id);
 GET DIAGNOSTICS moved_score_ledger=ROW_COUNT;
 UPDATE public.lab_arena_runs SET round_id='arena-2026-09-19-r313archive',
  submission_id='baseline-2026-09-19:r313archive'
  WHERE round_id='arena-2026-09-19' AND kind='execute'
   AND submission_id='baseline-2026-09-19';
 GET DIAGNOSTICS moved_baseline_runs=ROW_COUNT;
 UPDATE public.lab_arena_ledger SET round_id='arena-2026-09-19-r313archive',
  submission_id='baseline-2026-09-19:r313archive'
  WHERE round_id='arena-2026-09-19' AND submission_id='baseline-2026-09-19';
 ...
 UPDATE public.lab_arena_submissions SET source_ref='arena/arena-2026-09-19/sources/baseline-2026-09-19-rerun313-415f52f3.tar.gz',
  ...
  WHERE round_id='arena-2026-09-19' AND submission_id='baseline-2026-09-19';
 IF NOT FOUND THEN RAISE EXCEPTION 'Sep19 rerun313 baseline update missing'; END IF;
 UPDATE public.lab_arena_rounds SET status='stage1',
  ...
  updated_at=pg_catalog.clock_timestamp()
  WHERE round_id='arena-2026-09-19';
 IF NOT FOUND THEN RAISE EXCEPTION 'Sep19 rerun313 round update missing'; END IF;
 inserted_runs:=0;
 ...
 IF moved_scores<>50
  ...
  OR public.lab_arena_sep19_rerun313_archive_valid_v1() IS NOT TRUE
  OR public.lab_arena_sep19_rerun313_active_valid_v1() IS NOT TRUE
  OR EXISTS(SELECT 1 FROM public.lab_arena_runs
    WHERE round_id='arena-2026-09-19' AND kind='score') THEN
  RAISE EXCEPTION 'Sep19 rerun313 atomic preservation differs' USING ERRCODE='55000';
 END IF;
 RETURN pg_catalog.jsonb_build_object('status','prepared',
  ...
  'score_namespace','score:rerun313');
END $prepare313$;
ALTER FUNCTION public.lab_arena_prepare_sep19_rerun313_v1(
 BIGINT,TEXT,TEXT,JSONB,TEXT,TEXT) OWNER TO lab_arena_owner;
REVOKE ALL ON FUNCTION public.lab_arena_prepare_sep19_rerun313_v1(
 BIGINT,TEXT,TEXT,JSONB,TEXT,TEXT)
 FROM PUBLIC,anon,authenticated,service_role;
GRANT EXECUTE ON FUNCTION public.lab_arena_prepare_sep19_rerun313_v1(
 BIGINT,TEXT,TEXT,JSONB,TEXT,TEXT) TO lab_arena_service;

CREATE OR REPLACE FUNCTION public.lab_arena_sep19_rerun313_score_namespace_guard_v1()
RETURNS TRIGGER LANGUAGE plpgsql SECURITY DEFINER
SET search_path=pg_catalog,public AS $score_guard313$
BEGIN
 IF NEW.round_id='arena-2026-09-19' AND NEW.kind='score'
  AND EXISTS(SELECT 1 FROM public.lab_arena_rounds
   WHERE round_id='arena-2026-09-19-r313archive')
  AND NEW.assignment_id IS DISTINCT FROM NEW.round_id||':'||NEW.submission_id||':'||
   NEW.stage::TEXT||':'||NEW.icp_position::TEXT||':score:rerun313' THEN
  RAISE EXCEPTION 'Sep19 rerun313 scoring requires exact namespace'
   USING ERRCODE='55000';
 END IF;
 RETURN NEW;
END $score_guard313$;
ALTER FUNCTION public.lab_arena_sep19_rerun313_score_namespace_guard_v1()
 OWNER TO lab_arena_owner;
REVOKE ALL ON FUNCTION public.lab_arena_sep19_rerun313_score_namespace_guard_v1()
 FROM PUBLIC,anon,authenticated,service_role,lab_arena_service;
...
DROP TRIGGER IF EXISTS lab_arena_sep19_rerun313_score_namespace_guard
 ON public.lab_arena_runs;
CREATE TRIGGER lab_arena_sep19_rerun313_score_namespace_guard
 BEFORE INSERT ON public.lab_arena_runs FOR EACH ROW
 EXECUTE FUNCTION public.lab_arena_sep19_rerun313_score_namespace_guard_v1();
...
SELECT public.lab_arena_prepare_sep19_rerun313_v1(
 ...
 '{"benchmark_deadline":"2026-09-19T11:35:14Z","final_scoring_close":"2026-09-19T23:35:14Z","publication_deadline":"2026-09-19T23:35:15Z","stage_1_close":"2026-09-19T14:35:15Z","stage_1_scoring_close":"2026-09-19T17:35:14Z","stage_1_start":"2026-09-19T11:35:15Z","stage_2_close":"2026-09-19T20:35:15Z","stage_2_start":"2026-09-19T17:35:15Z","submission_cutoff":"2026-09-19T00:00:00Z","submission_open":"2026-09-18T00:00:00Z"}'::JSONB,
