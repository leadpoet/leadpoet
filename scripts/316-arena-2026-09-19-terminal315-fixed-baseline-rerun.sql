-- Render only after the Sep19 rerun315 round is terminal and every seal below
...
CREATE OR REPLACE FUNCTION public.lab_arena_sep19_rerun316_archive_valid_v1()
RETURNS BOOLEAN LANGUAGE plpgsql STABLE SECURITY DEFINER
SET search_path=pg_catalog,public,extensions AS $archive316$
...
BEGIN
 ...
 RETURN archived.status='cancelled'
  ...
  AND archived.cancel_reason='authorized_sep19_terminal315_fixed_baseline_archive'
  ...
  AND archived.configuration_doc->>'archived_terminal_cancel_reason'
      IS NOT DISTINCT FROM 'scoring_incomplete'
  AND archived.configuration_doc->>'archived_terminal_round_sha256'='4ef9e9be958539f71b4fd7703a6e58509bc44eeac2c9a1bb7aa687b57abfa964'
  AND archived.configuration_doc->>'archived_terminal_baseline_sha256'='0984ffab835dc4c057d78c3e21f7dcdc684c7d0adfa4db5f45169900c0f2a227'
  ...
  AND archived.configuration_doc->>'archived_terminal_runs_sha256'='7b7c79d770ddc36859ca8d71b051567f40cb49e61ee596af3af2b8a9dd8a6ede'
  AND archived.configuration_doc->>'archived_terminal_ledger_sha256'='b8c8728e954a021afefef44234be454b47d9ed7ceb9197cf7efcc6b9f40fc555'
  ...
  AND (SELECT pg_catalog.count(*) FROM public.lab_arena_submissions
       WHERE round_id='arena-2026-09-19-r316archive')=5
  AND (SELECT pg_catalog.count(*) FROM public.lab_arena_runs
       WHERE round_id='arena-2026-09-19-r316archive' AND kind='execute'
        AND submission_id='baseline-2026-09-19:r316archive')=39
  AND (SELECT pg_catalog.count(*) FROM public.lab_arena_runs
       WHERE round_id='arena-2026-09-19-r316archive' AND kind='execute'
        AND submission_id='baseline-2026-09-19:r316archive'
        AND status='accepted')=1
  AND (SELECT pg_catalog.count(*) FROM public.lab_arena_runs
       WHERE round_id='arena-2026-09-19-r316archive' AND kind='execute'
        AND submission_id='baseline-2026-09-19:r316archive'
        AND status='failed')=38
  AND (SELECT pg_catalog.count(*) FROM public.lab_arena_runs
       WHERE round_id='arena-2026-09-19-r316archive' AND kind='execute'
        AND submission_id='baseline-2026-09-19:r316archive'
  ...
  AND (SELECT pg_catalog.count(*) FROM public.lab_arena_runs
       WHERE round_id='arena-2026-09-19-r316archive' AND kind='score')=82
  AND NOT EXISTS(SELECT 1 FROM public.lab_arena_runs
       WHERE round_id='arena-2026-09-19-r316archive' AND kind='score'
        AND submission_id NOT LIKE '%:r316archive')
  AND NOT EXISTS(SELECT 1 FROM public.lab_arena_runs
       WHERE round_id='arena-2026-09-19-r316archive' AND kind='score'
  ...
  AND (SELECT pg_catalog.count(*) FROM public.lab_arena_ledger ledger
       WHERE ledger.round_id='arena-2026-09-19-r316archive'
        AND ledger.submission_id='baseline-2026-09-19:r316archive'
        AND EXISTS(SELECT 1 FROM public.lab_arena_runs run
          WHERE run.round_id='arena-2026-09-19-r316archive'
...
END $archive316$;
ALTER FUNCTION public.lab_arena_sep19_rerun316_archive_valid_v1()
 OWNER TO lab_arena_owner;
REVOKE ALL ON FUNCTION public.lab_arena_sep19_rerun316_archive_valid_v1()
 FROM PUBLIC,anon,authenticated,service_role,lab_arena_service;

CREATE OR REPLACE FUNCTION public.lab_arena_sep19_rerun316_active_valid_v1()
RETURNS BOOLEAN LANGUAGE plpgsql STABLE SECURITY DEFINER
SET search_path=pg_catalog,public AS $active316$
...
BEGIN
 ...
 RETURN active.round_id IS NOT NULL AND archived.round_id IS NOT NULL
  AND public.lab_arena_sep19_rerun316_archive_valid_v1() IS TRUE
  AND pg_catalog.encode(extensions.digest(pg_catalog.jsonb_build_object(
  ...
  AND EXISTS(SELECT 1 FROM public.lab_arena_submissions baseline
    WHERE baseline.round_id='arena-2026-09-19'
     ...
     AND baseline.source_ref='arena/arena-2026-09-19/sources/baseline-2026-09-19-rerun316-a9aab3da.tar.gz'
     AND baseline.source_size_bytes=790572
     AND baseline.submission_doc->>'source_sha256'='8f64bcf9cd10acd198ca9ede9a2a2b1da1445f747a5afb0d1de887575ea477b8'
     AND baseline.submission_doc->>'source_commit'='a9aab3dac66661b9d727109ba7eab59f2159aa2f')
  AND (SELECT pg_catalog.count(*) FROM public.lab_arena_runs
...
END $active316$;
ALTER FUNCTION public.lab_arena_sep19_rerun316_active_valid_v1()
 OWNER TO lab_arena_owner;
REVOKE ALL ON FUNCTION public.lab_arena_sep19_rerun316_active_valid_v1()
 FROM PUBLIC,anon,authenticated,service_role,lab_arena_service;

-- Replace the exact rerun315 guard and namespace in the current scorer. A
-- second stacked guard would reject rerun316 after the archive is created.
DO $patch_sep19_rerun316_scorer$
DECLARE definition TEXT; current_hash TEXT;
 old_assignment TEXT:=$assignment315$    IF p_round_id='arena-2026-09-19'
    ...
    END IF;
    v_status := CASE WHEN v_cache.cache_key IS NULL THEN 'pending' ELSE 'accepted' END;$assignment315$;
 old_guard TEXT:=$guard315$  IF p_round_id='arena-2026-09-19'
     AND EXISTS(SELECT 1 FROM public.lab_arena_rounds
...
BEGIN
 ...
 IF current_hash='0cf75a5ac52a23b51d761d03471deaa77e770175525b79befb6b75aa3d2ecb13' THEN
  IF (pg_catalog.length(definition)-pg_catalog.length(pg_catalog.replace(
   ...
   RAISE EXCEPTION 'Sep19 rerun316 scorer seam differs';
  END IF;
  ...
  EXECUTE definition;
 ELSIF current_hash<>'1bf82d9e27e385424ad96d0552573d63ecc84e55ea04ec81bcd8d74e07c07991' THEN
  RAISE EXCEPTION 'Sep19 rerun316 scorer definition differs';
 END IF;
 IF pg_catalog.encode(extensions.digest(pg_catalog.pg_get_functiondef(
   'public.lab_arena_open_scoring_v2(text,smallint,jsonb)'::pg_catalog.regprocedure),
   'sha256'),'hex')<>'1bf82d9e27e385424ad96d0552573d63ecc84e55ea04ec81bcd8d74e07c07991' THEN
  RAISE EXCEPTION 'Sep19 rerun316 scorer patch differs';
 END IF;
END $patch_sep19_rerun316_scorer$;

CREATE OR REPLACE FUNCTION public.lab_arena_prepare_sep19_rerun316_v1(
...
SET search_path=pg_catalog,public,extensions AS $prepare316$
DECLARE
...
BEGIN
 ...
 PERFORM pg_catalog.pg_advisory_xact_lock(
  pg_catalog.hashtextextended('arena-2026-09-19-rerun316',0));
 ...
 IF EXISTS(SELECT 1 FROM public.lab_arena_rounds
   WHERE round_id='arena-2026-09-19-r316archive') THEN
  IF public.lab_arena_sep19_rerun316_archive_valid_v1() IS NOT TRUE
   OR public.lab_arena_sep19_rerun316_active_valid_v1() IS NOT TRUE THEN
   RAISE EXCEPTION 'existing Sep19 rerun316 differs' USING ERRCODE='55000';
  END IF;
  RETURN pg_catalog.jsonb_build_object('status','existing',
   'round_id','arena-2026-09-19','fresh_baseline_execute_count',20,
   'retained_miner_execute_count',80,'score_namespace','score:rerun316');
 END IF;
 IF (p_schedule->>'benchmark_deadline')::TIMESTAMPTZ<=pg_catalog.clock_timestamp() THEN
  RAISE EXCEPTION 'Sep19 rerun316 admission window closed' USING ERRCODE='22023';
 END IF;
 ...
 IF active_round.status NOT IN('published','cancelled')
  ...
  OR active_round.cancel_reason IS DISTINCT FROM 'scoring_incomplete'
  ...
  OR pg_catalog.encode(extensions.digest(pg_catalog.to_jsonb(active_round)::TEXT,
       'sha256'),'hex')<>'4ef9e9be958539f71b4fd7703a6e58509bc44eeac2c9a1bb7aa687b57abfa964'
  OR pg_catalog.encode(extensions.digest(pg_catalog.to_jsonb(active_baseline)::TEXT,
       'sha256'),'hex')<>'0984ffab835dc4c057d78c3e21f7dcdc684c7d0adfa4db5f45169900c0f2a227'
  ...
  OR (SELECT pg_catalog.count(*) FROM public.lab_arena_runs
      WHERE round_id='arena-2026-09-19' AND kind='score')<>82
  ...
  RAISE EXCEPTION 'Sep19 rerun316 terminal preimage differs' USING ERRCODE='55000';
 END IF;
 IF pg_catalog.encode(extensions.digest(COALESCE((SELECT pg_catalog.string_agg(
  ...
  OR pg_catalog.encode(extensions.digest(COALESCE((SELECT pg_catalog.string_agg(
      ...
      WHERE round_id='arena-2026-09-19'),''),'sha256'),'hex')<>'7b7c79d770ddc36859ca8d71b051567f40cb49e61ee596af3af2b8a9dd8a6ede'
  OR pg_catalog.encode(extensions.digest(COALESCE((SELECT pg_catalog.string_agg(
      ...
      WHERE round_id='arena-2026-09-19'),''),'sha256'),'hex')<>'b8c8728e954a021afefef44234be454b47d9ed7ceb9197cf7efcc6b9f40fc555' THEN
  RAISE EXCEPTION 'Sep19 rerun316 terminal history differs' USING ERRCODE='55000';
 END IF;
 ...
 IF pg_catalog.jsonb_array_length(derived)<>119 THEN
  RAISE EXCEPTION 'Sep19 rerun316 derived judgment count differs'; END IF;
 expected_submission:=active_baseline.submission_doc||pg_catalog.jsonb_build_object(
  'source_ref','arena/arena-2026-09-19/sources/baseline-2026-09-19-rerun316-a9aab3da.tar.gz','source_size_bytes',790572,
  'source_sha256','8f64bcf9cd10acd198ca9ede9a2a2b1da1445f747a5afb0d1de887575ea477b8','source_commit','a9aab3dac66661b9d727109ba7eab59f2159aa2f');
 SELECT pg_catalog.jsonb_agg(CASE WHEN item->>'submission_id'='baseline-2026-09-19'
   THEN item||pg_catalog.jsonb_build_object('source_ref','arena/arena-2026-09-19/sources/baseline-2026-09-19-rerun316-a9aab3da.tar.gz',
    'source_size_bytes',790572) ELSE item END ORDER BY ordinal)
 ...
 archive_participants:=(SELECT pg_catalog.jsonb_agg(
   item||pg_catalog.jsonb_build_object('submission_id',(item->>'submission_id')||':r316archive')
 ...
 archive_config:=active_round.configuration_doc||pg_catalog.jsonb_build_object(
  'round_id','arena-2026-09-19-r316archive','mode','shadow','rewards_enabled',FALSE,
  ...
  'archived_terminal_round_sha256','4ef9e9be958539f71b4fd7703a6e58509bc44eeac2c9a1bb7aa687b57abfa964',
  'archived_terminal_baseline_sha256','0984ffab835dc4c057d78c3e21f7dcdc684c7d0adfa4db5f45169900c0f2a227',
  'archived_terminal_miner_submissions_sha256','781027021d3cadc5f2c0540d9f24a67f65cb25126912ef3544867d5a70153297',
  'archived_terminal_runs_sha256','7b7c79d770ddc36859ca8d71b051567f40cb49e61ee596af3af2b8a9dd8a6ede',
  'archived_terminal_ledger_sha256','b8c8728e954a021afefef44234be454b47d9ed7ceb9197cf7efcc6b9f40fc555',
 ...
 SELECT pg_catalog.jsonb_build_object(
  'rounds',(SELECT pg_catalog.jsonb_agg(pg_catalog.to_jsonb(r) ORDER BY round_id)
    FROM public.lab_arena_rounds r WHERE round_id NOT IN(
     'arena-2026-09-19','arena-2026-09-19-r316archive')),
 ...
 INSERT INTO public.lab_arena_rounds(
  ...
  NULL::public.lab_arena_rounds,pg_catalog.to_jsonb(active_round)||pg_catalog.jsonb_build_object(
   'round_id','arena-2026-09-19-r316archive','status','cancelled',
   ...
   'cancel_reason','authorized_sep19_terminal315_fixed_baseline_archive'));
 INSERT INTO public.lab_arena_submissions SELECT (pg_catalog.jsonb_populate_record(
  NULL::public.lab_arena_submissions,pg_catalog.to_jsonb(s)||pg_catalog.jsonb_build_object(
   'round_id','arena-2026-09-19-r316archive',
   'submission_id',s.submission_id||':r316archive'))).*
  FROM public.lab_arena_submissions s WHERE s.round_id='arena-2026-09-19';
 UPDATE public.lab_arena_runs SET round_id='arena-2026-09-19-r316archive',
  submission_id=submission_id||':r316archive'
  WHERE round_id='arena-2026-09-19' AND kind='score';
 GET DIAGNOSTICS moved_scores=ROW_COUNT;
 UPDATE public.lab_arena_ledger l SET round_id='arena-2026-09-19-r316archive',
  submission_id=submission_id||':r316archive'
  WHERE round_id='arena-2026-09-19' AND EXISTS(SELECT 1 FROM public.lab_arena_runs s
   WHERE s.round_id='arena-2026-09-19-r316archive' AND s.kind='score' AND s.run_id=l.run_id);
 GET DIAGNOSTICS moved_score_ledger=ROW_COUNT;
 UPDATE public.lab_arena_runs SET round_id='arena-2026-09-19-r316archive',
  submission_id='baseline-2026-09-19:r316archive'
  WHERE round_id='arena-2026-09-19' AND kind='execute'
   AND submission_id='baseline-2026-09-19';
 GET DIAGNOSTICS moved_baseline_runs=ROW_COUNT;
 UPDATE public.lab_arena_ledger SET round_id='arena-2026-09-19-r316archive',
  submission_id='baseline-2026-09-19:r316archive'
  WHERE round_id='arena-2026-09-19' AND submission_id='baseline-2026-09-19';
 ...
 UPDATE public.lab_arena_runs SET per_icp_score=NULL,qualification_doc=NULL
  WHERE round_id='arena-2026-09-19' AND kind='execute'
   AND submission_id<>'baseline-2026-09-19';
 UPDATE public.lab_arena_submissions SET source_ref='arena/arena-2026-09-19/sources/baseline-2026-09-19-rerun316-a9aab3da.tar.gz',
  source_size_bytes=790572,submission_doc=expected_submission,
  updated_at=pg_catalog.clock_timestamp()
  WHERE round_id='arena-2026-09-19' AND submission_id='baseline-2026-09-19';
 IF NOT FOUND THEN RAISE EXCEPTION 'Sep19 rerun316 baseline update missing'; END IF;
 UPDATE public.lab_arena_rounds SET status='stage1',
  ...
  updated_at=pg_catalog.clock_timestamp()
  WHERE round_id='arena-2026-09-19';
 IF NOT FOUND THEN RAISE EXCEPTION 'Sep19 rerun316 round update missing'; END IF;
 inserted_runs:=0;
 ...
 IF moved_scores<>82
  OR moved_score_ledger<>2171
  OR moved_baseline_runs<>39
  OR moved_baseline_ledger<>1167
  ...
  OR public.lab_arena_sep19_rerun316_archive_valid_v1() IS NOT TRUE
  OR public.lab_arena_sep19_rerun316_active_valid_v1() IS NOT TRUE
  OR EXISTS(SELECT 1 FROM public.lab_arena_runs
    WHERE round_id='arena-2026-09-19' AND kind='score') THEN
  RAISE EXCEPTION 'Sep19 rerun316 atomic preservation differs' USING ERRCODE='55000';
 END IF;
 RETURN pg_catalog.jsonb_build_object('status','prepared',
  ...
  'score_namespace','score:rerun316');
END $prepare316$;
ALTER FUNCTION public.lab_arena_prepare_sep19_rerun316_v1(
 BIGINT,TEXT,TEXT,JSONB,TEXT,TEXT) OWNER TO lab_arena_owner;
REVOKE ALL ON FUNCTION public.lab_arena_prepare_sep19_rerun316_v1(
 BIGINT,TEXT,TEXT,JSONB,TEXT,TEXT)
 FROM PUBLIC,anon,authenticated,service_role;
GRANT EXECUTE ON FUNCTION public.lab_arena_prepare_sep19_rerun316_v1(
 BIGINT,TEXT,TEXT,JSONB,TEXT,TEXT) TO lab_arena_service;

CREATE OR REPLACE FUNCTION public.lab_arena_sep19_rerun316_score_namespace_guard_v1()
RETURNS TRIGGER LANGUAGE plpgsql SECURITY DEFINER
SET search_path=pg_catalog,public AS $score_guard316$
BEGIN
 IF NEW.round_id='arena-2026-09-19' AND NEW.kind='score'
  AND EXISTS(SELECT 1 FROM public.lab_arena_rounds
   WHERE round_id='arena-2026-09-19-r316archive')
  AND NEW.assignment_id IS DISTINCT FROM NEW.round_id||':'||NEW.submission_id||':'||
   NEW.stage::TEXT||':'||NEW.icp_position::TEXT||':score:rerun316' THEN
  RAISE EXCEPTION 'Sep19 rerun316 scoring requires exact namespace'
   USING ERRCODE='55000';
 END IF;
 RETURN NEW;
END $score_guard316$;
ALTER FUNCTION public.lab_arena_sep19_rerun316_score_namespace_guard_v1()
 OWNER TO lab_arena_owner;
REVOKE ALL ON FUNCTION public.lab_arena_sep19_rerun316_score_namespace_guard_v1()
 FROM PUBLIC,anon,authenticated,service_role,lab_arena_service;
...
DROP TRIGGER IF EXISTS lab_arena_sep19_rerun316_score_namespace_guard
 ON public.lab_arena_runs;
CREATE TRIGGER lab_arena_sep19_rerun316_score_namespace_guard
 BEFORE INSERT ON public.lab_arena_runs FOR EACH ROW
 EXECUTE FUNCTION public.lab_arena_sep19_rerun316_score_namespace_guard_v1();
