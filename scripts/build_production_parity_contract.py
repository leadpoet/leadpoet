...
ALWAYS_COMMITTED_PATHS = (
    ...
    ".github/workflows/production-parity-snapshot.yml",
    "infra/production-parity-staging.yml",
    "infra/production-parity-config.example.json",
    "infra/leadpoet-production-parity-auditor.service",
    ...
    "scripts/build_production_parity_epoch_authority.py",
    ...
    "scripts/production_parity_database_host.py",
    ...
    "scripts/run_production_parity_auditor.py",
    "scripts/run_production_parity_dashboard.py",
