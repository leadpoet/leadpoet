...
unset GATEWAY_CONTROLLER_PROCESS_HELPER
unset LAB_ARENA_PROCESS_HELPER
...
unset GATEWAY_ACTIVE_RELEASE_COMPONENT
unset PREPARED_GATEWAY_SHA
unset LAB_ARENA_RESTART_GUARD_GENERATION
