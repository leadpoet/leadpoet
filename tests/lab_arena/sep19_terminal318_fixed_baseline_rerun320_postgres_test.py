"""Prepared PostgreSQL proof for a future sealed Sep19 rerun320 render."""
    ...
    with conn.cursor() as cursor:
        ...
        cursor.execute(
            ...
            SELECT entry_kind,miner_hotkey,round_id,submission_id,run_id,stage,
                   'sha256:'||'168c44c338eec07dfd6bf9e529f573fb9ae31940624dc9e6dac76d234d9e10e4','openrouter','openrouter.responses','host',
...
def test_terminal318_rerun_executes_scores_and_publishes_with_preservation(
...
def test_terminal318_preimage_requires_exact_shape_active_validity_and_settlement(
...
def test_template_is_sealed_terminal318_only():
    body = TEMPLATE.read_text()
...
def test_exact_render_has_terminal_seals_and_rejects_wrong_preimage_atomically(
    ...
    assert "moved_baseline_runs<>36" in body
    assert "moved_baseline_ledger<>16698" in body
    for terminal_seal in (
        ...
        '320e15b2eb26cf571e80abad40fe65c7433184fd41211f11cf09be2ab79064f4',
        '66d90b41a988043762c491598401f627ef9467bf2051b9308698b2314f7f7c96',
        ...
        '7fc79ca58856200455e7109630a50ec5207e54374711688d55909c426573abf0',
        '5f97b2a744e74540b6e79beb82a9b7bd8ee82e84ad27a2a310ee885771fb74c7',
    ):
    ...
    try:
        ...
        with conn.cursor() as cursor:
            ...
            previous_archive_before = _round_history(cursor, ROUND + "-r318archive")
