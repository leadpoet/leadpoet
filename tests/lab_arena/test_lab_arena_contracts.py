...
def test_journal_chain_and_receipt_and_reward_basis_contracts():
    ...
    plan = c.finalize_scoring_plan({
        ...
        "work_items": [{"work_item_id": c.work_item_id(c.document_hash("i"), "s1", c.document_hash("o")), "icp_position": 0, "icp_hash": c.document_hash("i"), "output_hash": c.document_hash("o"), "submission_id": "s1"}],
