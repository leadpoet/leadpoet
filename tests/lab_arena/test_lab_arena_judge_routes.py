...
def test_plain_quotas_and_priced_model_access_keep_judge_models_private_to_scoring_runs():
    assert contracts.CALL_QUOTAS_PER_ICP == {"scrapingdog": 200, "deepline": 200, "openrouter": 2000}
    assert contracts.SCORING_CALL_QUOTAS_PER_WORK_ITEM == {"scrapingdog": 2000, "deepline": 2000, "openrouter": 2000}
