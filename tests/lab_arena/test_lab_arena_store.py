...
RECOVERY_ADMIN_RPCS = (
    (
        ...
        {
            "p_source_size_bytes": 585058,
            "p_source_sha256": "9" * 64,
            "p_source_commit": "b" * 40,
            "p_bank_sha256": "5" * 64,
            "p_forward_schedule": {"stage_1_close": "2026-09-17T22:00:00Z"},
        },
        (
    ...
    (
        ...
        {
            "p_source_size_bytes": 582000,
            "p_source_sha256": "8" * 64,
            "p_source_commit": "a" * 40,
            "p_bank_sha256": "5" * 64,
            "p_forward_schedule": {"stage_1_close": "2026-09-17T22:00:00Z"},
        },
        (
    ...
    (
        ...
        {
            "p_source_size_bytes": 581173,
            "p_source_sha256": "7" * 64,
            "p_source_commit": "f" * 40,
            "p_bank_sha256": "5" * 64,
            "p_forward_schedule": {"stage_1_close": "2026-09-17T20:00:00Z"},
        },
        (
            "p_source_size_bytes => %s::bigint",
            "p_source_sha256 => %s::text",
    ...
    (
        "lab_arena_prepare_sep16_baseline_recovery275_v1",
        {
            ...
            "p_source_sha256": "f" * 64,
            "p_source_commit": "a" * 40,
            "p_forward_schedule": {"stage_1_close": "2026-09-18T12:00:00Z"},
        },
        (
            "p_source_size_bytes => %s::bigint",
            "p_source_sha256 => %s::text",
    ...
    (
        ...
        {
            "p_source_size_bytes": 533090,
            "p_source_sha256": (
                "72a008e2cacde52921c4be94951839edccc321d90de07741010a3100463eef32"
            ),
            "p_source_commit": "0a19bd28177628d01b5ce1f4fc54cc459d7d4f51",
            "p_forward_schedule": {"stage_1_close": "2026-09-17T08:00:00Z"},
        },
        (
            "p_source_size_bytes => %s::bigint",
            "p_source_sha256 => %s::text",
