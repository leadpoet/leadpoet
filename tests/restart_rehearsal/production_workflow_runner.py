...
def _exercise_settlement_frontier_terminal_retirement() -> dict[str, Any]:
    ...
    source_add_checkpoint = build_reward_settlement_checkpoint_v2(
        ...
        source_id="source_add_reward:" + "d" * 16,
    ...
    if (
        successor["reward_checkpoint_count"] != 1
        or successor["reward_checkpoints"] != [source_add_checkpoint]
        or observed_queries
    ...
    return {
        ...
        "historical_checkpoint_preserved_without_reward_query": True,
        "tampered_identity_rejected": True,
        "successor_reward_checkpoint_count": 1,
    ...
    behavioral_invariants = {
        ...
        "settlement_frontier_terminal_retirement_verified": (
            ...
            and behavior_evidence.get(
                "settlement-frontier-terminal-retirement",
                {},
            ).get("historical_checkpoint_preserved_without_reward_query")
            is True
            and behavior_evidence.get(
                "settlement-frontier-terminal-retirement",
                {},
