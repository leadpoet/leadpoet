...
def test_scoring_import_closure_contains_authority_modules():
    ...
    assert {
        ...
        "research_lab/sourcing_model_contract_v27.json",
        ...
        "research_lab/sourcing_model_parity_fixtures_v27.json",
...
def test_gateway_code_hash_includes_verifier_runtime_data():
    ...
    assert (
        "_attested_runtime/research_lab/sourcing_model_contract_v11.json" in files
    )
    assert (
    ...
    assert (
        "_attested_runtime/research_lab/sourcing_model_contract_v27.json" in files
    )
    assert (
    ...
    assert (
        "_attested_runtime/research_lab/sourcing_model_parity_fixtures_v11.json"
        in files
    )
    assert (
    ...
    assert (
        "_attested_runtime/research_lab/sourcing_model_parity_fixtures_v27.json"
        in files
    )
