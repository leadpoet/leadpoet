...
def signed_basis(signer: LocalSigner, *, pool_percent: int = 25, effective: int = 24801, start: int = 24801, outcome: str = "crowned", hotkey: str = KING) -> Dict[str, Any]:
    basis = rewards.reward_basis_document(
        round_id="arena-2026-09-02", configuration_hash=_sha("cfg"), commitment_hash=_sha("cm"), result_bundle_hash=_sha("rb"),
...
def test_coordinator_requires_an_empty_legacy_slot_without_a_basis(monkeypatch):
