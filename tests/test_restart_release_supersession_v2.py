...
VALIDATOR_LAB_ARENA_GUARD_REQUEST_OUTPUT=/tmp/leadpoet-restart-fixture-arena-request.json
VALIDATOR_LAB_ARENA_GUARD_PERMIT_INPUT=/tmp/leadpoet-restart-fixture-arena-permit.json
VALIDATOR_LAB_ARENA_GUARD_HANDOFF_NONCE=aaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa
