...
test "$VALIDATOR_ACTIVE_RELEASE_COMPONENT" = validator
test "$VALIDATOR_LAB_ARENA_GUARD_REQUEST_OUTPUT" = "$EXPECTED_GUARD_REQUEST"
test "$VALIDATOR_LAB_ARENA_GUARD_PERMIT_INPUT" = "$EXPECTED_GUARD_PERMIT"
test "$VALIDATOR_LAB_ARENA_GUARD_HANDOFF_NONCE" = "$EXPECTED_GUARD_NONCE"
test "$VALIDATOR_LAB_ARENA_GUARD_HANDOFF_TIMEOUT_SECONDS" = 9300
...
GATEWAY_ACTIVE_RELEASE_COMPONENT=gateway
...
VALIDATOR_ACTIVE_RELEASE_COMPONENT=validator
VALIDATOR_PAIRED_ACTIVE_RELEASE_REQUIRED=0
VALIDATOR_LAB_ARENA_GUARD_REQUEST_OUTPUT={tmp_path / 'guard-request.json'!s}
VALIDATOR_LAB_ARENA_GUARD_PERMIT_INPUT={tmp_path / 'guard-permit.json'!s}
VALIDATOR_LAB_ARENA_GUARD_HANDOFF_NONCE={'a' * 64}
VALIDATOR_LAB_ARENA_GUARD_HANDOFF_TIMEOUT_SECONDS=9300
export EXPECTED_GUARD_REQUEST="$VALIDATOR_LAB_ARENA_GUARD_REQUEST_OUTPUT"
export EXPECTED_GUARD_PERMIT="$VALIDATOR_LAB_ARENA_GUARD_PERMIT_INPUT"
export EXPECTED_GUARD_NONCE="$VALIDATOR_LAB_ARENA_GUARD_HANDOFF_NONCE"
