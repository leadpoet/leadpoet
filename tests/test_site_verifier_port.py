...
def test_default_mode_enforces_canonical_mismatch(monkeypatch) -> None:
...
def test_invalid_mode_falls_back_to_enforce(monkeypatch) -> None:
    monkeypatch.setenv("RESEARCH_LAB_TAXONOMY_INDUSTRY_GATE", "banana")
    assert pre_checks._taxonomy_industry_gate_mode() == "enforce"
