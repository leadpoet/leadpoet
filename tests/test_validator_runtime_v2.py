...
def test_one_time_legacy_runtime_binds_lineage_without_cutover_authority():
    runtime, _, _ = _runtime()
    configuration = _configuration()
    configuration["schema_version"] = VALIDATOR_RUNTIME_CONFIG_SCHEMA_VERSION
    del configuration["epoch_authority"]
    ...
    assert runtime.epoch_authority() is None
    assert set(runtime.gateway_release_lineage()) == {"a" * 40, "e" * 40}
