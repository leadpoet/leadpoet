...
TRUELIST_BATCH_STRATEGY = "accurate"  # "accurate" yields far fewer inconclusive verdicts at 9k-lead scale than "fast"; "fast" triggers a 3-round retry cascade + long inline SMTP fallback that overruns the 30-min coordinator timeout every epoch
