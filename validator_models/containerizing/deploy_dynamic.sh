...
LEADPOET_SENTRY_ENV_ARGS=(
    ...
    -e LEADPOET_RESTART_INVOCATION_ID
)
...
start_container() {
    ...
    if [ "$CONTAINER_ID" -eq 0 ]; then
        ...
        INPUT_JOURNAL_ARG="-e VALIDATOR_V2_INPUT_JOURNAL_DIR=/app/validator_weights/authoritative_weight_inputs_v2"
