...
PROTECTED_SYMBOLS = {
    ...
    "validator_tee/enclave/tee_service.py": (
        "MAX_VSOCK_RPC_CLEANUP_ATTEMPTS",
    ...
    "leadpoet_canonical/hotkey_authority_v2.py": (
        ...
        "parse_weight_transport_authorization_message_v2",
    ...
    "leadpoet_canonical/auditor_latest_verified_bundle_v2.py": (
        ...
        "LatestVerifiedBundleStoreV2.load",
        "LatestVerifiedBundleStoreV2.replace_if_newer",
    ),
    ...
    "neurons/validator.py": (
        ...
        "WEIGHT_FINALIZATION_PROOF_RETRY_SECONDS",
    ...
    "neurons/auditor_validator.py": (
        "VERIFIED_BUNDLE_FALLBACK_BLOCK",
        ...
        "AuditorValidator._persist_latest_verified_bundle",
        "AuditorValidator._load_and_reverify_latest_verified_bundle",
        "AuditorValidator.submit_weights_to_chain",
        "AuditorValidator._submit_verified_authority_once",
        "AuditorValidator._submit_latest_verified_bundle_fallback",
        "AuditorValidator._run_latest_verified_bundle_fallback_loop",
